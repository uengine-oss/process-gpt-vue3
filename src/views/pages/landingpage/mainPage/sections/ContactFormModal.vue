                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="text-left">
                            ...
                            <input
                                ...
                                type="text"
                                required
                                class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-ui-primary"
                                :placeholder="$t('CTASection.namePlaceholder')"
                            />
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="text-left">
                            ...
                            <input
                                ...
                                required
                                class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-ui-primary"
                                :placeholder="$t('CTASection.companyPlaceholder')"
                            />
                        </div>
                        <div class="text-left mb-3">
                            ...
                            <input
                                ...
                                type="text"
                                class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-ui-primary"
                                :placeholder="$t('CTASection.positionPlaceholder')"
                            />
                        </div>
                    </div>
                    <div class="text-left">
                        ...
                        <textarea
                            ...
                            rows="4"
                            class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-ui-primary"
                            :placeholder="$t('CTASection.messagePlaceholder')"
                            style="resize: none"
                        ></textarea>
                    </div>
            ...
            <div class="privacy-modal-content">
                ...
                <div class="privacy-modal-body">
                    <div class="prose max-w-none text-left">
                        ...
                        <br />{{ $t('CTASection.privacyPolicyDescription2') }} <br />{{ $t('CTASection.privacyPolicyDescription3') }}
                    </div>
                </div>
                <div class="privacy-modal-footer">
                    <button
                        @click="showPrivacyPolicy = false"
                        class="px-8 py-2 font-bold btn btn-privacy-modal rounded-lg hover:bg-ui-primary-dark"
                    >
