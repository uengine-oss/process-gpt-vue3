<template>
    <div v-if="isPresentationMode" class="slide-presentation" @keydown="handleKeydown" tabindex="0" :class="{ 'print-mode': printPdf }">
        <div class="presentation-controls pa-4 pb-0 d-flex" v-if="!printPdf">
            ...
            <v-btn @click="closeModal" :color="themeColor" variant="flat" icon density="compact">
                <v-icon size="18">mdi-arrow-left</v-icon>
            </v-btn>
        </div>

        <div class="slide-container">
            <slide-component :key="markdownContent" :content="markdownContent" :isEditMode="false" class="presentation-slide" />
