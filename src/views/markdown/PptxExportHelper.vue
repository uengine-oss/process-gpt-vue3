        ...
        <div class="modal" v-if="showModal">
            <div class="modal-content">
                <v-row class="ma-0 pa-4 align-center">
                    ...
                    <v-spacer></v-spacer>
                    <v-btn @click="closeModal" icon variant="text" density="comfortable" style="margin-top: -8px">
                ...
                <div class="modal-body">
                    ...
                    <div class="export-config">
                        ...
                        <div class="config-item">
                            ...
                            <input type="text" v-model="fileName" placeholder="presentation.pptx" class="text-input" />
                        </div>
                    </div>

                    <div class="actions">
                        <v-btn @click="exportToPptx" :color="themeColor" variant="elevated" class="rounded-pill" density="compact"
