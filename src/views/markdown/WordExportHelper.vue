                ...
                <div class="modal-body">
                    ...
                    <div class="export-config">
                        <div class="config-item">
                            ...
                            <input type="text" v-model="fileName" placeholder="document.docx" class="text-input" />
                        </div>
                    </div>

                    <div class="actions">
                        <v-btn @click="exportToDocx" :color="themeColor" variant="elevated" class="rounded-pill" density="compact"
