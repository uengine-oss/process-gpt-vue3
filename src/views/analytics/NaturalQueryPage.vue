            ...
            <v-card elevation="10" class="is-work-height">
                ...
                <div class="pa-6" style="overflow: auto; height: calc(100vh - 200px)">
                    ...
                    <v-alert v-if="store.cubes.length === 0 && !store.loading" type="info" variant="tonal" class="mb-4">
                        ...
                        <div class="text-body-2">자연어 질의를 사용하려면 먼저 피벗 테이블에서 Mondrian XML 스키마를 업로드하세요.</div>
                        <template #append>
                            <v-btn variant="flat" color="info" size="small" to="/analytics/pivot"> 피벗 테이블로 이동 </v-btn>
                        </template>
                    </v-alert>
