                                ...
                                <v-row>
                                    ...
                                    <v-col cols="6" sm="3">
                                        <div class="text-h6 font-weight-bold text-deep-purple">
                                            {{ (humanStats.avgF1 * 100).toFixed(1) }}%
                                        </div>
                                        <div class="text-caption text-medium-emphasis">평균 F1</div>
                                    </v-col>
                                    <v-col cols="6" sm="3">
                                        <div class="text-h6 font-weight-bold text-deep-purple">
                                            {{ humanStats.avgDuration.toFixed(0) }}초
                                        </div>
                                        <div class="text-caption text-medium-emphasis">평균 처리시간</div>
                                    </v-col>
                                    <v-col cols="6" sm="3">
                    ...
                    <v-row>
                        <v-col cols="12" md="6">
                            <div class="pa-4 rounded border">
                                ...
                                <div class="chart-wrapper">
                                    <Line v-if="canRenderF1Chart" :chartData="safeF1ChartData" :chartOptions="chartOptions" />
                        ...
                        <v-col cols="12" md="6">
                            <div class="pa-4 rounded border">
                                ...
                                <div class="chart-wrapper">
                                    <Bar v-if="canRenderTaskCountChart" :chartData="safeTaskCountChartData" :chartOptions="chartOptions" />
                                    <div v-else class="d-flex align-center justify-center" style="height: 150px">
                                        <v-progress-circular indeterminate color="primary" size="24" />
                                    </div>
                                </div>
