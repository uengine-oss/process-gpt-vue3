...
function getStateLabel(state: string): string {
    const map: Record<string, string> = {
        ...
        archived: '아카이빙',
        cancelled: '취소',
        approved_level1: '1차승인',
        approved_level2: '2차승인'
    };
...
function setupRealtime() {
    ...
    realtimeChannel = supabase
        ...
        .on('postgres_changes', { event: 'UPDATE', schema: 'public', table: 'proc_def_approval_state' }, (payload: any) => {
