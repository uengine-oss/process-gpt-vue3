...
const displayName = computed(() => {
    ...
    if ((item.state === 'approved_level1' || item.state === 'approved_level2') && item.reviewer_level1_name)
        return item.reviewer_level1_name;
...
<template>
    <div class="rbc" :class="{ 'rbc--stalled': isStalled }" @click="handleClick">
        ...
        <div class="rbc-row-title">
            ...
            <span v-if="accessBadge" class="rbc-access-badge" :style="{ background: accessBadge.bg, color: accessBadge.color }">{{
                accessBadge.label
            }}</span>
            <span v-else-if="editBadge" class="rbc-access-badge" :style="{ background: editBadge.bg, color: editBadge.color }">{{
                editBadge.label
            }}</span>
        </div>
        ...
        <div class="rbc-row-meta">
            <div class="d-flex align-center gap-2 flex-1 min-w-0">
                <div class="rbc-avatar" :style="{ background: avatarColor }">{{ initials }}</div>
