    ...
    <div class="review-board-root">
        ...
        <div class="page-header">
            ...
            <div class="page-header-right">
                <span v-if="reviewItems.length > 0" class="in-review-badge"> {{ reviewItems.length }} In Review </span>
                <v-btn variant="tonal" color="primary" size="small" rounded="lg" @click="router.push('/my-inbox')">
