                        ...
                        <v-table class="month-table" fixed-header height="400px">
                            ...
                            <tbody>
                                <tr v-for="item in tableFixedHeaderData" :key="item.name" class="month-item">
                                    ...
                                    <td>
                                        <v-chip rounded="pill" v-if="item.statusoffline" class="font-weight-bold pl-1 pr-2"
                                            :color="item.statuscolor" size="small">
                                            <ClockHour4Icon size="15" class="mr-1" />
                                            {{ item.status }}
                                        </v-chip>

                                        <v-chip rounded="pill" v-else class="font-weight-bold pl-1 pr-2"
                                            :color="item.statuscolor" size="small">
                                    ...
                                    <td>
                                        <div class="d-flex align-center">
                                            <div class="d-flex">
                                                <v-chip v-for="team in item.teams" :key="team.status" rounded="pill"
