<template>
    <div>
        <slot v-if="canvas"> </slot>
        <div class="canvas-wrapper">
            <div class="canvas-container" :id="id"></div>
        </div>
...
export default {
    ...
    mounted: function () {
        ...
        this.OGBus.on('renderingTime', function (a, b) {
    ...
    methods: {
        ...
        bindEvents: function () {
            ...
            me.canvas.onAddHistory(function (event) {
                ...
                me.$nextTick(function () {
                    ...
                    //이를 위해서는 오픈그래프의 메서드를 오버라이드 해야한다. => updateSlider => 캔버스 사이즈 강제 고정으로.
            ...
            me.canvas.onBeforeRemoveShape(function (event, element) {
                var result;
                me.$emit('beforeRemoveShape', me.getElementById(element.id) || element, function (emitResult) {
                    result = emitResult;
                });
                return result;
            });
        ...
        removeElement: function (id) {
            ...
            var result;
            this.$emit('beforeDestroyElement', me.getElementById(id), function (emitResult) {
                result = emitResult;
            });
