    ...
    methods: {
            ...
            if (!shape) {
                ...
                switch (shape.TYPE) {
                    ...
                    case OG.Constants.SHAPE_TYPE.GROUP:
                        me.element = me.canvasComponent.canvas.drawShape(
                            [me.x, me.y],
                            shape,
                            [me.width, me.height, me.angle],
                            style,
                            me._id,
                            me.parentId
                        );
                ...
                this.OGBus.emit('renderingTime', this.canvasComponent.id, Date.now() - now);
            }
        },
        setGroup: function () {
            var me = this;
            ...
            //그룹위에 그려졌을 경우 그룹처리
            var frontGroup = me.canvasComponent.canvas
                .getRenderer()
        ...
        bindShapeEvents: function (shape) {
            ...
            shape.onGroup = function (groupShapeEle) {
                me.$emit('group', me.canvasComponent.getElementById(groupShapeEle.id) || groupShapeEle);
            };
            ...
            shape.onAddToGroup = function (groupElement, elements, eventOffset) {
                ...
                me.$emit('addToGroup', me.canvasComponent.getElementById(groupElement.id) || groupElement, addedComponents, eventOffset);
            };
            /**
