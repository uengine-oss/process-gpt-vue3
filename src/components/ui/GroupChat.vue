<template>
                ...
                <div class="message-info-content">
                  <template v-if="isReply">
                    <div class="message-info-header">
                      <div>
                        {{ replyUser.role === 'system' ? $t('chat.systemReply') : $t('chat.userReply', { name: replyUser.name }) }}
                      </div>
  ...
  const showFileUpload = computed(() => {
    return (props.type === 'instances' || props.type === 'chats' || props.type === 'consulting') && 
           props.agentInfo && 
  ...
  watch(() => props.newMessageInfo, (newVal) => {
