                ...
                <v-card-text>
                    <v-col>
                        ...
                        <v-row style="margin-top: 20px">
                            <v-data-table-virtual :items="currentInvoice" :headers="currentInvoiceHeaders"> </v-data-table-virtual>
                        </v-row>
                    </v-col>
                </v-card-text>
            </v-card>
            ...
            <v-card elevation="10">
                <v-card-text>
                    <v-col>
                        ...
                        <v-row style="margin-top: 20px">
                            <v-data-table-virtual :items="previousInvoice" :headers="previousInvoiceHeaders"> </v-data-table-virtual>
                        </v-row>
                    </v-col>
                </v-card-text>
            </v-card>
