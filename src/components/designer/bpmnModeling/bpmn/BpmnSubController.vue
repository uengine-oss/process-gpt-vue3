<template>
    <div>
        <sub-controller v-if="clone.intermediate" cloneable :image="'event_intermediate.png'" v-on:clone="intermediateClone">
            <circle-element :width="100" :height="28"></circle-element>
        </sub-controller>

        <sub-controller v-if="clone.end" cloneable :image="'event_end.png'" v-on:clone="endClone">
            <circle-element :width="30" :height="30"></circle-element>
        </sub-controller>

        <sub-controller v-if="clone.gateway" cloneable :image="'gateway_exclusive.png'" v-on:clone="exclusiveGatewayClone">
            <circle-element :width="40" :height="40"></circle-element>
        </sub-controller>

        <sub-controller v-if="clone.task" cloneable :image="'task.png'" v-on:clone="taskClone">
            <circle-element :width="100" :height="70"></circle-element>
        </sub-controller>

        <sub-controller v-if="clone.annotaion" cloneable :image="'annotation.png'" v-on:clone="annotaionClone">
            <circle-element :width="100" :height="30"></circle-element>
        </sub-controller>

        <sub-controller v-if="clone.call" :image="'popup.png'" v-on:click="popDefinition">
            <circle-element :width="100" :height="30"></circle-element>
        </sub-controller>

        <sub-controller v-if="clone.wrench" :image="'wrench.png'" v-on:click="showComponentChange"></sub-controller>
