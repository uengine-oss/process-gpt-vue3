<template>
    <bpmn-common-panel v-model="value" :image="image" :is-read-only="readOnly" :width-style="widthStyle" @close="closePanel">
        <template v-slot:name-panel>
            <v-text-field v-model="value.name" label="Pool/Lane (Role) Name" autofocus></v-text-field>
        </template>
        <template v-slot:edit-property>
            <v-radio-group v-model="isRoleDef" row>
                <v-radio id="roleDef" name="roleDef" value="Human" label="Human"></v-radio>
                <v-radio id="roleDef" name="roleDef" value="System" label="System"></v-radio>
            </v-radio-group>
            ...
            <div v-if="isRoleDef == 'System'">
                <v-select v-model="value.name" :items="serviceIdList" label="Select serviceId from eureka"></v-select>
            </div>
