            ...
            <v-table density="comfortable" class="elevation-1">
                ...
                <tbody>
                    <tr v-for="(ex, idx) in copyUengineProperties.io_examples" :key="idx">
                        ...
                        <td class="text-right">
                            <v-btn size="x-small" variant="text" color="secondary" @click="openIoDialog(ex, idx)">
            ...
            <v-card>
                <v-card-text>
                    <div class="mb-2 text-caption opacity-70">
                        {{ $t('BpmnPropertyPanel.result') }}:
                        <v-chip size="small" class="ml-1" :color="selectedExample?.output === true ? 'success' : 'error'" variant="flat">
                        ...
                        <v-table density="comfortable" class="elevation-1">
                            ...
                            <tbody>
                                <tr v-for="(ex, idx) in ioExamplesGood" :key="'good-' + idx">
                                    ...
                                    <td class="text-right">
                                        <v-btn size="x-small" variant="text" color="secondary" @click="openIoDialog(ex)">
                                            {{ $t('BpmnPropertyPanel.view') }}
                                        </v-btn>
                                    </td>
                                </tr>
