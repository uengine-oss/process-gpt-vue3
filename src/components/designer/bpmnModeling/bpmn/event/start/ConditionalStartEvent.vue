<template>
    <div>
        ...
        >
            <geometry-circle :center="[50, 50]" :radius="50"></geometry-circle>

            <sub-elements>
                <bpmn-state-animation :status="status" :type="type"></bpmn-state-animation>

                <!-- 위 선 -->
                <geometry-line :from="[30, 20]" :to="[70, 20]"></geometry-line>
                <!-- 오른쪽 선 -->
                <geometry-line :from="[70, 20]" :to="[70, 80]"></geometry-line>

                <!-- 아래 선-->
                <geometry-line :from="[30, 80]" :to="[70, 80]"></geometry-line>

                <!-- 왼쪽 선-->
                <geometry-line :from="[30, 20]" :to="[30, 80]"></geometry-line>

                <!-- 위 -->
                <geometry-line :from="[33, 32]" :to="[67, 32]"></geometry-line>
                <geometry-line :from="[33, 44]" :to="[67, 44]"></geometry-line>
                <geometry-line :from="[33, 56]" :to="[67, 56]"></geometry-line>
                <geometry-line :from="[33, 68]" :to="[67, 68]"></geometry-line>
            </sub-elements>
        ...
        <bpmn-start-event-panel v-if="drawer" v-model="value" @close="closePanel"></bpmn-start-event-panel>
    </div>
</template>
