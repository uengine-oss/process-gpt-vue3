<template>
    <div>
        ...
        >
            ...
            <geometry-circle :center="[50, 50]" :radius="44"></geometry-circle>

            <sub-elements>
                <bpmn-state-animation :status="status" :type="type"></bpmn-state-animation>

                <!-- 오른쪽 짧은 선 -->
                <geometry-line :from="[76, 30]" :to="[61, 63]"></geometry-line>

                <!-- 오른쪽 긴 선 -->
                <geometry-line :from="[76, 30]" :to="[61, 81]"></geometry-line>

                <!-- 왼쪽 잛은 선-->
                <geometry-line :from="[24, 70]" :to="[39, 37]"></geometry-line>

                <!-- 왼쪽 긴 선-->
                <geometry-line :from="[24, 70]" :to="[39, 19]"></geometry-line>

                <!-- 위 -->
                <geometry-line :from="[39, 19]" :to="[61, 63]"></geometry-line>

                <!-- 아래 -->
                <geometry-line :from="[61, 81]" :to="[39, 37]"></geometry-line>
            </sub-elements>
        ...
        <bpmn-intermediate-event-panel v-if="drawer" v-model="value" @close="closePanel"></bpmn-intermediate-event-panel>
    </div>
</template>
