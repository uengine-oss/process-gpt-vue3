    ...
    <div>
        <div>
            <div>
                <v-row>
                    <v-col cols="2">
                        <v-select v-model="value._type" :items="typeList" item-text="key" item-value="value"></v-select>
                        (
                    </v-col>
                    <v-col></v-col>
                </v-row>
            ...
            <ul>
                ...
                <v-row>
                    <v-col cols="3">
                        <v-select v-model="conditionType" :items="conditionTypeList" item-text="key" item-value="value"></v-select>
                    </v-col>
                    <v-col cols="2">
