    ...
    <div>
        ...
        >
            <div>
                ...
                <div id="dataCon">
                    <v-select v-model="value.condition" :items="comparatorList" label="Comparator" @change="conditionChanged"></v-select>
                </div>

                <div id="dataVal">
                    <v-text-field v-model="value.val" label="Value"></v-text-field>
                </div>
            </div>
        </v-card>
    </div>
