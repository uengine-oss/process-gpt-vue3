    ...
    <div>
        <div v-if="status == 'Failed'">
            ...
            <div v-if="type == 'StartEvent' || type == 'EndEvent' || type == 'IntermediateEvent' || type == 'Gateway'">
                <image-element v-bind:image="failed_image" :sub-width="'20px'" :sub-height="'20px'" :sub-right="'5px'" :sub-bottom="'5px'">
                    <!-- <md-tooltip md-direction="bottom">My tooltip</md-tooltip> -->
                </image-element>
            </div>
            <div v-else>
                <image-element v-bind:image="failed_image" :sub-width="'20px'" :sub-height="'20px'" :sub-right="'6%'" :sub-top="'5px'">
                    <!-- <md-tooltip md-direction="bottom">My tooltip</md-tooltip> -->
                </image-element>
            </div>
        </div>
        ...
        <div v-if="status == 'Running'">
            ...
            <component
                :is="
                    type == 'StartEvent' || type == 'EndEvent' || type == 'IntermediateEvent' || type == 'Gateway'
                        ? 'circle-element'
                        : 'rectangle-element'
                "
                :sub-z-index="-1"
...
export default {
    ...
    data: function () {
        ...
        return {
            ...
            complete_image: '/static/image/symbol/complete.png',
            running_image: '/static/image/symbol/running.png',
            stopped_image: '/static/image/symbol/stopped.png',
            failed_image: '/static/image/symbol/failed.png'
            // faultMessage: ''
        };
    },
    watch: {},
