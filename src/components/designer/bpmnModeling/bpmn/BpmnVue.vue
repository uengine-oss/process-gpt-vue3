<template>
    <div>
        ...
        <bpmn-component-changer v-if="data.definition" :data="componentChangerData"></bpmn-component-changer>

        <!-- 프로세스 변수 -->
        <v-dialog v-model="processVariablesDialog" v-if="data.definition" max-width="900">
            <v-card>
                <v-card-title>Process Variables</v-card-title>
                <v-card-text>
                    <bpmn-object-grid v-model="processVariables" :full-fledged="true"></bpmn-object-grid>
                </v-card-text>
                <v-card-actions>
                    <v-spacer></v-spacer>
        ...
        <!-- 프로세스 정의 -->
        <v-dialog v-if="data.definition" v-model="definitionSettings" ref="definitionSettings" max-width="320">
            <v-card>
