    ...
    <v-row class="ma-0">
        <v-col cols="12">
            ...
            <v-row class="align-center">
                ...
                <v-col cols="12" sm="9">
                    <v-text-field
                        v-model="processVariable.description"
                        color="primary"
                        variant="outlined"
                        id="hem"
                        type="text"
            ...
            <v-row class="align-center">
                ...
                <v-col cols="12" sm="9">
                    <v-autocomplete
                        v-model="processVariable.datasource.type"
                        :items="datasources"
                        color="primary"
                        variant="outlined"
                        hide-details
                ...
                <v-col cols="12">
                    <v-textarea
                        v-if="processVariable.datasource?.type == 'SQL' || processVariable.datasource?.type == 'database'"
