        ...
        <v-layout right>
            ...
            <v-flex style="justify: end; align: start">
                <v-row v-if="!monitor" justify="end" align="start" style="margin-right: 15px">
                    <v-text-field
                        style="margin-right: 10px; margin-top: 8px; max-width: 300px"
                        label="Process Name"
                    ...
                    <div v-if="versions" style="margin-right: 10px">
                        <v-select
                            v-for="(version, idx) in versions.slice().reverse()"
                            :key="idx"
                            v-on="on"
                    ...
                    <div v-if="definition" style="margin-right: 10px">
                        <v-select
                            v-model="definition._selectedLocale"
                            :items="languageItems"
                            item-value="value"
                            item-text="title"
                            @change="changeLocale"
                    ...
                    <div>
                        ...
                        <v-menu offset-y open-on-hover left>
                            <template v-slot:activator="{ on }">
                                <v-btn style="margin-right: 15px; margin-top: 15px" color="orange" dark fab small v-on="on" @click="save">
        ...
        value: {
            default: function () {
                return {
                    ...
                    name: {},
                    childActivities: ['java.util.ArrayList', []],
                ...
                if (activity.childActivities && activity.childActivities[1] && activity.childActivities[1].length) {
                    ...
                    $.each(activity.childActivities[1], function (i, child) {
                        ...
                        if (child._type == 'org.uengine.kernel.HumanActivity') {
                            child.role.name = me.$refs['bpmn-vue'].getWhereRoleAmIByTracingTag(child.tracingTag);
