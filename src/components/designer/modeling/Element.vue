...
export default {
    ...
    computed: {
        style: {
            get: function () {
                ...
                if (this.value) {
                    if (this.value.elementView) style = this.value.elementView.style;
                    else style = this.value.relationView.style;
                }
            ...
            set: function (val) {
                if (this.value) {
                    if (this.value.elementView) this.value.elementView.style = JSON.stringify(val);
                    else this.value.relationView.style = JSON.stringify(val);
                }
            }
        }
    },
    ...
    methods: {
        ...
        difference: _.debounce(function (object, base) {
