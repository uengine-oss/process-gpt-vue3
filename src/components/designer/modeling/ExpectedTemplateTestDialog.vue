                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        <v-row>
                                            <Icons :icon="'file-document-edit-outline'" :size="20" :color="'#2278cf'" 
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        <v-row>
                                            <Icons :icon="'file-document-plus-outline'" :size="20" :color="'green'" 
                                                style="position: relative; left: -30px;"
                                                :style="diffPathList[filePath].subPath && diffPathList[filePath].subPath != '' ? 'top: 20px;':'top: 9px;'"
                                            />
                                            <v-col style="margin-left:-35px; margin-right: 25px;">
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        <v-row>
                                            <Icons :icon="'file-document-minus-outline'" :size="20" :color="'red'" 
                                                style="position: relative; left: -30px;"
                                                :style="diffPathList[filePath].subPath && diffPathList[filePath].subPath != '' ? 'top: 20px;':'top: 9px;'"
                                            />
                                            <v-col style="margin-left:-35px; margin-right: 25px;">
