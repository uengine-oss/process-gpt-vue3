        ...
        <v-card>
            ...
            <v-card-text>
                ...
                <v-checkbox v-if="condition.isReplay" v-model="condition.usedSCM" dense style="margin-top: -10px">
                    <template v-slot:label> Attach SCM version </template>
                </v-checkbox>
                <v-text-field
                ...
                <v-textarea outline v-model="condition.comment" name="input-7-4" label="Comment" :counter="255" rows="4"></v-textarea>
            </v-card-text>
