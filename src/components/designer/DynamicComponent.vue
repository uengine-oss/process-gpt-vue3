...
export default {
    ...
    render() {
        ...
        switch (tagName) {
            case 'text-field':
                return this.createComponentWithRef(TextField, {
                    vueRenderUUID: this.vueRenderUUID,
                    tagName: tagName,
                    ...this.parseContentToProps(this.content)
                });
            case 'select-field':
                return this.createComponentWithRef(SelectField, {
                    vueRenderUUID: this.vueRenderUUID,
                    tagName: tagName,
                    ...this.parseContentToProps(this.content)
                });
            case 'checkbox-field':
                return this.createComponentWithRef(CheckboxField, {
                    vueRenderUUID: this.vueRenderUUID,
                    tagName: tagName,
                    ...this.parseContentToProps(this.content)
                });
            case 'radio-field':
                return this.createComponentWithRef(RadioField, {
                    vueRenderUUID: this.vueRenderUUID,
                    tagName: tagName,
                    ...this.parseContentToProps(this.content)
                });
            ...
            case 'label-field':
                return this.createComponentWithRef(LabelField, {
                    vueRenderUUID: this.vueRenderUUID,
                    tagName: tagName,
                    ...this.parseContentToProps(this.content)
                });
            case 'boolean-field':
                return this.createComponentWithRef(BooleanField, {
                    vueRenderUUID: this.vueRenderUUID,
                    tagName: tagName,
                    ...this.parseContentToProps(this.content)
                });
            case 'textarea-field':
                return this.createComponentWithRef(TextareaField, {
                    vueRenderUUID: this.vueRenderUUID,
                    tagName: tagName,
                    ...this.parseContentToProps(this.content)
                });
            case 'user-select-field':
                return this.createComponentWithRef(UserSelectField, {
                    vueRenderUUID: this.vueRenderUUID,
                    tagName: tagName,
                    ...this.parseContentToProps(this.content)
                });
            case 'code-field':
                return this.createComponentWithRef(CodeField, {
                    vueRenderUUID: this.vueRenderUUID,
                    tagName: tagName,
                    ...this.parseContentToProps(this.content)
                });
            case 'report-field':
                return this.createComponentWithRef(ReportField, {
                    vueRenderUUID: this.vueRenderUUID,
                    tagName: tagName,
                    ...this.parseContentToProps(this.content)
                });
            case 'slide-field':
                return this.createComponentWithRef(SlideField, {
                    vueRenderUUID: this.vueRenderUUID,
                    tagName: tagName,
                    ...this.parseContentToProps(this.content)
                });
            case 'bpmn-uengine-field':
                return this.createComponentWithRef(BpmnUengineField, {
                    vueRenderUUID: this.vueRenderUUID,
                    tagName: tagName,
                    ...this.parseContentToProps(this.content)
                });
