    ...
    methods: {
        ...
        resolvePos(spec) {
            ...
            if (block != null) {
                ...
                if (block.appendable == true) {
                    if (
                        this.appendComponent != undefined &&
                        this.appendComponent[spec[0]] != undefined &&
                        this.appendComponent[spec[0]] == true
                    ) {
        ...
        updateMousePos(event) {
            if (this.pendingConnection) {
                this.pendingConnection[this.pendingConnectionEnd] = this.mousePos(event);
            }
            ...
            return () => {
                if (this.pendingConnection) {
                    if (
                        ...
                        const duplicateIndex = _.findIndex(this.connections, this.pendingConnection);
        ...
        isConnectionDuplicate(connection) {
            return this.tempConnections.some(
                (conn) =>
