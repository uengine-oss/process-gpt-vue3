<template>
    <div v-if="onLoad">
        ...
        <div class="d-flex align-items-center">
            <v-card
                class="d-flex justify-center align-center pa-3 mb-3 details-title-card"
                elevation="10"
                style="background-color: rgb(var(--v-theme-primary), 0.2)"
            >
                <div class="d-flex flex-column justify-content-center align-items-center">
                    <h6 class="text-h6 font-weight-semibold text-center">Mega<br />Process</h6>
                </div>
            </v-card>
            ...
            <v-card class="d-flex align-center pa-3 mb-3" elevation="10" style="background-color: rgb(var(--v-theme-primary), 0.2)">
        ...
        <div
            ...
            v-if="filteredProcess && filteredProcess.major_proc_list && filteredProcess.major_proc_list.length > 0"
        >
            <v-card
                class="d-flex justify-center align-center pa-2 mb-3 details-title-card"
                elevation="10"
                style="border-radius: 20px !important; margin-bottom: 5px; border: 5px solid rgba(var(--v-theme-primary), 0.2)"
            >
                <div class="d-flex flex-column justify-content-center align-items-center">
                    <h6 class="text-h6 font-weight-semibold text-center">Major<br />Process</h6>
                </div>
            </v-card>
            <div class="line-with-dots d-flex">
                <div class="dot"></div>
        ...
        <div
            ...
            v-if="
                ...
                filteredProcess.major_proc_list.some((proc) => proc.sub_proc_list && proc.sub_proc_list.length > 0)
            "
        >
            <v-card class="d-flex justify-center align-center pa-3 mb-3 bg-white details-title-card" elevation="10">
                <div class="justify-content-center align-items-center">
                    <h6 class="text-h6 font-weight-semibold text-center">Sub<br />Process</h6>
                </div>
            </v-card>
            <div class="line-with-dots d-flex">
                <div class="dot"></div>
