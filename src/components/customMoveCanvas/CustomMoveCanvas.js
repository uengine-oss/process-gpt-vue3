import { set as cursorSet, unset as cursorUnset } from 'diagram-js/lib/util/Cursor';
...
// import MoveCanvas from 'diagram-js/lib/navigation/movecanvas/MoveCanvas';
...
MoveCanvas.$inject = ['eventBus', 'canvas', 'elementRegistry'];
