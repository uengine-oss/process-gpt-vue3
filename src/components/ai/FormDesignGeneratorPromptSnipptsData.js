...
const formDesignGeneratorPromptSnipptsData = {
    ...
    componentInfos: [
        {
            tag: `<text-field name='<이 입력창의 고유한 이름>' alias='<이 입력창의 별명>' type='<text|number|email|url|date|datetime-local|month|week|time|password|tel>' disabled='<true|false>'></text-field>`,
