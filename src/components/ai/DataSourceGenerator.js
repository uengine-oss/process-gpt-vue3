...
export default class DataSourceGenerator extends AIGenerator {
    ...
    constructor(client, language) {
        ...
        this.previousMessagesFormat = [
          ...
          - **Confidence Scoring**: Rate paths 0.0-1.0 based on usefulness for form fields
          ...
          **Important**: Analyze the ENTIRE response structure, not just 'paths' property. Look for any patterns that could represent API endpoints or data collections.
          ...
          - **Confidence Levels**: Include mappings with >70% confidence for real data
          - **No Data Handling**: If no valid sample data exists, return empty mappings array
          
          **Important for Mapping**: Only create mappings when actual data is available. If APIs failed or data is empty, return empty mappings array.
            ...
            "mappings": [
              {
                ...
                "valueColumn": "name",
                "confidence": 0.85,
                "reason": "Field name strongly suggests department selection, mock data shows appropriate id/name structure"
              }
            ]
          }
          \`\`\`
