...
export default class ProcessConsultingMentoGenerator extends AIGenerator {
    ...
    constructor(client, language) {
        ...
        this.previousMessages = [{
            ...
            메시지 목록을 보고 개선된 컨설팅 시스템의 질문이 어느정도 의미가 비슷하다면 적절하다고 판단해야한다. 부적절이라고 판단할때는 그렇게 판단한 명확한 근거가 있고 컨설팅 시스템의 질문이 과하게 부적절, 불필요 또는 주제와 많이 벗어났을때 그렇게 판단할 수 있다.
            주제와 크게 벗어난 경우 부적합하다고 판단하고 크게 벗어나지 않고 주제와 비슷한 경우 적절하다고 판단해야한다. 적절한 질문이라고 판단하는 기준을 보다 널널하게 판단해야한다. 몇 글자 차이로 부적절하다고 판단하는 경우가 많기때문이다.
            질문의 내용이나 방향이 적당히 비슷하다면 적절한 질문이라고 판단해. 현재 질문의 의미가 적절하거나 이전과 동일한데 부적절하다는 판단이 많이 나오고 있기때문에 보다 널널하게 판단해.
