<template>
    <div ref="ganttContainer" class="custom-gantt-container" style="width: 100%; height: 100%"></div>
</template>
            ...
            gantt.form_blocks['calendar_picker'] = {
                ...
                set_value: function (node, value, task, section) {
                    ...
                    if (value) {
                        ...
                        input.value = `${date.getFullYear()}-${String(date.getMonth() + 1).padStart(2, '0')}-${String(
                            date.getDate()
                        ).padStart(2, '0')}`;
                    }
            ...
            gantt.attachEvent('onLightbox', function (taskId) {
                setTimeout(() => {
                    ...
                    if (lightboxButtons) {
                        ...
                        lightboxButtons.addEventListener(
                            'click',
                            function (e) {
