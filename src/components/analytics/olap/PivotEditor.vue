            ...
            <v-card>
                <v-card-title class="d-flex justify-space-between align-center">
                    ...
                    <div class="d-flex ga-2">
                        ...
                        <v-btn variant="tonal" size="small" prepend-icon="mdi-refresh" @click="store.resetPivotConfig"> 초기화 </v-btn>
                        <v-btn
                            color="success"
                            size="small"
                ...
                <v-card-text>
                    ...
                    <v-row>
                        ...
                        <v-col cols="4">
                            ...
                            <draggable v-model="store.pivotConfig.rows" group="fields" item-key="level" class="drop-zone pa-3 rounded-lg">
                    ...
                    <v-expand-transition>
                        <div v-if="showSQL && store.generatedSQL" class="mt-4">
                            ...
                            <div class="d-flex justify-space-between align-center mb-2">
                                <span class="text-caption text-medium-emphasis text-uppercase font-weight-medium"> 생성된 SQL </span>
                                <v-btn variant="text" size="x-small" prepend-icon="mdi-content-copy" @click="copySQL"> 복사 </v-btn>
                            </div>
