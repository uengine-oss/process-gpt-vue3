...
<template>
    <v-card>
        ...
        <v-card-text>
            ...
            <!-- Tips -->
            <v-expand-transition>
                <v-alert v-if="showTips" type="info" variant="tonal" class="mb-4" closable @click:close="showTips = false">
            ...
            <div v-if="queryHistory.length > 0">
                ...
                <v-list density="compact" class="bg-transparent">
                    <v-list-item v-for="(item, idx) in queryHistory" :key="idx" class="px-2 rounded" @click="useHistoryItem(item)">
                        <template #prepend>
