...
KEditor.DEFAULTS = {
    ...
    onSnippetsLoading: function () {
        console.log('onSnippetsLoading');
    },
    ...
    onInitSidebar: function () {},
    onInitComponent: function (component) {
        console.log('onInitComponent', component);
    },
    initContentAreas: function (component, contentArea) {},
...
KEditor.prototype = {
    ...
    initSidebar: function () {
        ...
        if (typeof options.onInitSidebar === 'function') {
            options.onInitSidebar.call(null, self);
        }
    },
    ...
    initSnippetsFilter: function (type) {
        ...
        filterHtml +=
            '     <input type="text" id="keditor-' +
            lowerCaseType +
            '-snippets-search" class="keditor-ui keditor-snippets-search" value="" placeholder="타입 검색" />';
        filterHtml +=
            '     <select id="keditor-' +
            lowerCaseType +
            '-snippets-filter" class="keditor-ui keditor-snippets-filter" style="font-size: small; height: 40px;">';
    ...
    renderSnippets: function (resp) {
        ...
        $('<div />')
            ...
            .each(function (i) {
                ...
                snippetHtml +=
                    '<section class="keditor-ui keditor-snippet" data-snippet="#keditor-snippet-' +
                    i +
                    '" data-type="' +
                    type +
                    '" data-categories="' +
                ...
                var dataAttributes = self.getDataAttributes(
                    snippet,
                    ['data-preview', 'data-type', 'data-keditor-title', 'data-keditor-title-en', 'data-categories'],
                    true
                );
                snippetsContentHtml +=
                    '<script id="keditor-snippet-' + i + '" type="text/html" ' + dataAttributes.join(' ') + '>' + content + '</script>';
            });
        ...
        body.find('#' + options.snippetsListId)
            .html(
                '<ul id="keditor-snippets-type-switcher" class="keditor-ui keditor-tabs">' +
                    '    <li class="keditor-ui keditor-tab active"><a class="keditor-ui" href="#keditor-container-snippets-tab"' +
                    (options.tabTooltipEnabled ? 'data-toggle="tooltip" data-placement="bottom"' : '') +
                    ' title="' +
                    options.tabContainersTitle +
                    '">' +
                    options.tabContainersText +
                    '</a></li>' +
                    '    <li class="keditor-ui keditor-tab"><a class="keditor-ui" href="#keditor-component-snippets-tab"' +
                    (options.tabTooltipEnabled ? 'data-toggle="tooltip" data-placement="bottom"' : '') +
                    ' title="' +
                    options.tabComponentsTitle +
                    '">' +
                    options.tabComponentsText +
                    '</a></li>' +
                    '</ul>' +
                    '<div id="keditor-snippets-container" class="keditor-ui keditor-tabs-content">' +
                    '   <div class="keditor-ui keditor-tab-content active" id="keditor-container-snippets-tab"><div class="keditor-ui keditor-tab-content-inner">' +
                    snippetsContainerHtml +
                    '</div></div>' +
                    '   <div class="keditor-ui keditor-tab-content" id="keditor-component-snippets-tab"><div class="keditor-ui keditor-tab-content-inner">' +
    ...
    initSnippets: function () {
        ...
        snippetsList.find('.keditor-snippet[data-type=container]').draggable({
            ...
            stop: function () {
                snippetsList
                    .find('.keditor-snippet[data-type^=component]')
                    .draggable('option', 'connectToSortable', body.find('.keditor-container-content'));
            }
        });
    ...
    initTabs: function () {
        ...
        if (options.extraTabs && $.isPlainObject(options.extraTabs)) {
            ...
            for (var tabName in options.extraTabs) {
                ...
                switcherWrapper.append(
                    '<li class="keditor-ui keditor-tab"><a class="keditor-ui" href="#keditor-extra-tab-' +
                        tabName +
                        '"' +
                        (options.tabTooltipEnabled ? 'data-toggle="tooltip" data-placement="bottom" title="' + tabData.title + '"' : '') +
                        '>' +
                        tabData.text +
                        '</a></li>'
                );
                tabPaneWrapper.append(
                    '<div class="keditor-ui keditor-tab-content" id="keditor-extra-tab-' +
                        tabName +
                        '"><div class="keditor-tab-content-inner">' +
                        tabData.content +
                        '</div></div>'
                );
            }
        ...
        if (isComponent) {
            ...
            if (settingForm.length === 0) {
                ...
                if (typeof componentData.initSettingForm === 'function') {
                    settingForm = $(
                        '<div id="keditor-setting-' +
                            componentType +
                            '" data-type="' +
                            componentType +
                            '" class="keditor-ui keditor-setting-form clearfix active"></div>'
                    );
    ...
    initContentAreas: function (target) {
        ...
        if (typeof options.initContentAreas === 'function') {
            options.initContentAreas.call(self, target);
        }
    },
    ...
    convertToContainer: function (contentArea, target) {
        ...
        if (isSection) {
            ...
            target.wrap(
                '<section class="keditor-ui keditor-container"><section class="keditor-ui keditor-container-inner"></section></section>'
            );
    ...
    initContainer: function (contentArea, container) {
        ...
        if (!container.hasClass('keditor-initialized-container') || !container.hasClass('keditor-initializing-container')) {
            ...
            if (options.containerSettingEnabled === true) {
                settingBtn =
                    '<a href="javascript:void(0);" class="keditor-ui btn-container-setting">' + options.btnSettingContainerText + '</a>';
            }

            flog('Render KEditor toolbar for container', container);
            container.append(
                '<div class="keditor-toolbar keditor-toolbar-container">' +
                    '   <a href="javascript:void(0);" class="keditor-ui btn-container-reposition">' +
                    options.btnMoveContainerText +
                    '</a>' +
                    settingBtn +
                    '   <a href="javascript:void(0);" class="keditor-ui btn-container-duplicate">' +
                    options.btnDuplicateContainerText +
                    '</a>' +
                    '   <a href="javascript:void(0);" class="keditor-ui btn-container-delete">' +
                    options.btnDeleteContainerText +
                    '</a>' +
                    '</div>'
            );
            ...
            receive: function (event, ui) {
                ...
                if (ui.item.attr('data-type') === 'component-object-form') {
                    ...
                    if (item.is('.keditor-snippet')) {
                        ...
                        var component = $(
                            '<section class="keditor-ui keditor-component" data-type="' +
                                componentType +
                                '" ' +
                                dataAttributes.join(' ') +
                                '>' +
    ...
    convertToComponent: function (contentArea, container, target, isExisting) {
        ...
        if (isSection) {
            ...
            target.wrap(
                '<section class="keditor-ui keditor-component"><section class="keditor-ui keditor-component-content"></section></section>'
            );
    ...
    initComponent: function (contentArea, container, component) {
        ...
        if (!component.hasClass('keditor-initialized-component') || !component.hasClass('keditor-initializing-component')) {
            ...
            // }
            settingBtn =
                '<a href="javascript:void(0);" class="keditor-ui btn-component-setting">' + options.btnSettingComponentText + '</a>';

            flog('Render KEditor toolbar for component', component);
            component.append(
                '<div class="keditor-toolbar keditor-toolbar-component">' +
                    '   <a href="javascript:void(0);" class="keditor-ui btn-component-reposition">' +
                    options.btnMoveComponentText +
                    '</a>' +
                    settingBtn +
                    '   <a href="javascript:void(0);" class="keditor-ui btn-component-duplicate">' +
                    options.btnDuplicateComponentText +
                    '</a>' +
                    '   <a href="javascript:void(0);" class="keditor-ui btn-component-delete">' +
                    options.btnDeleteComponentText +
                    '</a>' +
                    '</div>'
            );
    ...
    initKEditorClicks: function () {
        ...
        body.on('click', '.btn-container-duplicate', function (e) {
            ...
            componentSnippets.draggable(
                'option',
                'connectToSortable',
                currentLinkedContainerContents.add(newContainer.find('.keditor-container-content'))
            );
            ...
            if (confirm('Are you sure that you want to delete this container? This action can not be undo!')) {
                ...
                if (settingComponent) {
                    ...
                    if (settingComponentParent.is(container)) {
                        flog(
                            'Deleting container is container of setting container. Close setting panel for this setting component',
                            settingComponent
                        );
                        self.hideSettingPanel();
                    }
