/* jquery.nicescroll 3.6.6 InuYaksa*2015 MIT http://nicescroll.areaaperta.com */ (function (e) {
    'function' === typeof define && define.amd
        ? define(['jquery.nicescroll.min'], e)
    ...
    var x = window.MutationObserver || window.WebKitMutationObserver || !1,
        ...
        R = function () {
            ...
            d.transitionend = !1;
            for (
                var n = 'transition webkitTransition msTransition MozTransition OTransition OTransition KhtmlTransition'.split(' '),
                    p = ' -webkit- -ms- -moz- -o- -o -khtml-'.split(' '),
                    q =
        ...
        S = function (k, c) {
            ...
            function p(b, g, l, c) {
                a._bind(
                    ...
                    function (a) {
                        ...
                        'mousewheel' == g
                            ? ((c.deltaY = -0.025 * a.wheelDelta), a.wheelDeltaX && (c.deltaX = -0.025 * a.wheelDeltaX))
                            : (c.deltaY = a.detail);
                        return l.call(b, c);
                    },
                    c
            ...
            function q(b, g, c) {
                ...
                0 == b.deltaMode
                    ? ((d = -Math.floor((a.opt.mousescrollstep / 54) * b.deltaX)),
                      (f = -Math.floor((a.opt.mousescrollstep / 54) * b.deltaY)))
                    : 1 == b.deltaMode &&
                      ((d = -Math.floor(b.deltaX * a.opt.mousescrollstep)), (f = -Math.floor(b.deltaY * a.opt.mousescrollstep)));
                g &&
                    a.opt.oneaxismousemode &&
                    0 == d &&
                    f &&
                    ((d = f), (f = 0), c && (0 > d ? a.getScrollLeft() >= a.page.maxw : 0 >= a.getScrollLeft()) && ((f = d), (d = 0)));
                d &&
            ...
            this.isrtlmode =
                'auto' == this.opt.rtlmode
                    ? 'rtl' == (this.win[0] == window ? this.body : this.win).css('direction')
                    : !0 === this.opt.rtlmode;
            ...
            this.debounced = function (b, g, c) {
                ...
                a.delaylist[b] = g;
                d ||
                    (a.debouncedelayed = setTimeout(function () {
                        if (a) {
                            var g = a.delaylist[b];
                            a.delaylist[b] = !1;
                            g.call(a);
            ...
            if (this.ishwscroll) {
                ...
                f.hastranslate3d && a.opt.enabletranslate3d
            ...
            this.updateScrollBar = function (b) {
                if (a.ishwscroll)
                    ...
                    if (a.railh && !a.railslocked) {
                        ...
                        b = a.railh.align
                            ? c + d(a.win, 'border-top-width', !0) + a.win.innerHeight() - a.railh.height
                ...
                if (!a.ispage || (!f.cantouch && !f.isieold && !f.isie9mobile)) {
                    ...
                    a.ispage &&
                        ...
                        ('BODY' == a.doc[0].nodeName
                            ...
                            : 'HTML' == a.doc[0].nodeName && a.css(e('body'), { 'overflow-y': 'hidden' }));
                    ...
                    l.css({ width: l.width + 'px', zIndex: a.zindex, background: a.opt.background, cursor: 'default' });
                    l.visibility = !0;
                    l.scrollable = !0;
                    ...
                    a.opt.horizrailenabled &&
                        ...
                        f.isieold && c.css({ overflow: 'hidden' }),
                    ...
                    a.ispage
                        ...
                        : (a.ishwscroll
                              ? ('static' == a.win.css('position') && a.css(a.win, { position: 'relative' }),
                                ...
                                a.zoom &&
                                    (a.zoom.css({ position: 'absolute', top: 1, right: 0, 'margin-right': l.width + 4 }), b.append(a.zoom)),
                              ...
                              : ((a.isfixed = 'fixed' == a.win.css('position')),
                                ...
                                a.viewport &&
                                    ((a.body = a.viewport),
                                    0 == /fixed|absolute/.test(a.viewport.css('position')) && a.css(a.viewport, { position: 'relative' })),
                                l.css({ position: b }),
                                a.zoom && a.zoom.css({ position: b }),
                                a.updateScrollBar(),
                                a.body.append(l),
                                a.zoom && a.body.append(a.zoom),
                                a.railh && (m.css({ position: b }), a.body.append(m))),
                          f.isios && a.css(a.win, { '-webkit-tap-highlight-color': 'rgba(0,0,0,0)', '-webkit-touch-callout': 'none' }),
                          f.isie && a.opt.disableoutline && a.win.attr('hideFocus', 'true'),
                          f.iswebkit && a.opt.disableoutline && a.win.css({ outline: 'none' }));
                    !1 === a.opt.autohidemode
                        ...
                        ? ((a.autohidedom = e().add(a.rail)),
                          ...
                          a.railh && f.isie8 && (a.autohidedom = a.autohidedom.add(a.cursorh)))
                    ...
                    if (f.isie9mobile)
                        (a.scrollmom = new M(a)),
                            (a.onmangotouch = function () {
                                ...
                                if (0 != Math.round(Math.sqrt(Math.pow(f, 2) + Math.pow(g, 2)))) {
                                    ...
                                    80 < e - a.mangotouch.tm || a.mangotouch.dry != d || a.mangotouch.drx != l
                                        ? (a.scrollmom.stop(),
                            ...
                            (l = a.getScrollTop()),
                            (m = a.getScrollLeft()),
                            (a.mangotouch = { sy: l, ly: l, dry: 0, sx: m, lx: m, drx: 0, lazy: !1, tm: 0 }),
                        ...
                        if (f.cantouch || a.istouchcapable || a.opt.touchbehavior || f.hasmstouch) {
                                ...
                                if (!a.railslocked) {
                                    ...
                                    if (a.ispage || !a.opt.directionlockdeadzone) a.rail.drag.dl = 'f';
                                        ...
                                        var g = e(window).width(),
                                            ...
                                            d = Math.max(
                                                0,
                                                Math.max(document.body.scrollHeight, document.documentElement.scrollHeight) - d
                                            ),
                                    ...
                                    if (!f.cantouch && !this.istouchcapable && !b.pointerType) {
                                        if (!c || !/INPUT|SELECT|TEXTAREA/i.test(c.nodeName))
                                            return (
                                                !a.ispage && f.hasmousecapture && c.setCapture(),
                                                a.opt.touchbehavior
                                                    ? (c.onclick &&
                                                          !c._onclick &&
                            ...
                            a.ontouchend = function (b) {
                                ...
                                if (2 == a.rail.drag.pt) {
                                    ...
                                    if (
                                        a.hasmoving &&
                                        ((a.lastmouseup = !0), a.hideCursor(), f.hasmousecapture && document.releaseCapture(), !f.cantouch)
                                    )
                                        return a.cancelEvent(b);
                            ...
                            a.ontouchmove = function (b, c) {
                                ...
                                if (2 == a.rail.drag.pt) {
                                    ...
                                    a.ishwscroll && a.opt.bouncescroll
                                        ...
                                        : (0 > k && (l = k = 0), k > a.page.maxh && ((k = a.page.maxh), (l = 0)));
                                    var r;
                                    a.railh &&
                                        a.railh.scrollable &&
                                        ((r = a.isrtlmode ? w - a.rail.drag.sl : a.rail.drag.sl - w),
                                        a.ishwscroll && a.opt.bouncescroll
                                            ? 0 > r
                                                ? (r = Math.round(r / 2))
                                                : r > a.page.maxw && (r = a.page.maxw + Math.round((r - a.page.maxw) / 2))
                                            : (0 > r && (h = r = 0), r > a.page.maxw && ((r = a.page.maxw), (h = 0))));
                                    g = !1;
                                    if (a.rail.drag.dl)
                                        (g = !0),
                                        ...
                                        if ('v' == a.rail.drag.ck) {
                                            if (d > m && w <= 0.3 * d) return (a.rail.drag = !1), !0;
                                            w > m && ((a.rail.drag.dl = 'f'), e('body').scrollTop(e('body').scrollTop()));
                                        } else if ('h' == a.rail.drag.ck) {
                                            if (w > m && d <= 0.3 * w) return (a.rail.drag = !1), !0;
                                    ...
                                    a.synched('touchmove', function () {
                                        a.rail.drag &&
                                            ...
                                            a.railh && a.railh.scrollable ? (a.setScrollLeft(r), a.showCursor(k, r)) : a.showCursor(k),
                        ...
                        if (f.cantouch || a.opt.touchbehavior)
                            (a.onpreventclick = function (b) {
                                ...
                                a.opt.grabcursorenabled &&
                                    f.cursorgrabvalue &&
                                    (a.css(a.ispage ? a.doc : a.win, { cursor: f.cursorgrabvalue }),
                                    a.css(a.rail, { cursor: f.cursorgrabvalue }));
                        else {
                            var q = function (b) {
                                if (a.selectiondrag) {
                                    if (b) {
                        ...
                        f.cantouch || a.opt.touchbehavior
                        ...
                        a.opt.enablemousewheel &&
                            (a.isiframe || a.bind(f.isie && a.ispage ? document : a.win, 'mousewheel', a.onmousewheel),
                        ...
                        ((a.observerbody = new x(function (b) {
                            b.forEach(function (b) {
                                if ('attributes' == b.type)
                                    return e('body').hasClass('modal-open') && !e.contains(e('.modal-dialog')[0], a.doc[0])
                                        ? a.hide()
                                        : a.show();
                            });
            ...
            this.showCursor = function (b, c) {
                ...
                if (a.rail) {
                    ...
                    (a.rail.drag && 1 == a.rail.drag.pt) ||
                        ('undefined' != typeof b && !1 !== b && (a.scroll.y = Math.round((1 * b) / a.scrollratio.y)),
            ...
            this.bind = function (b, c, d, e) {
                ...
                'mousewheel' == c
                    ? 'onwheel' in a.win
                        ? a._bind(h, 'wheel', d, e || !1)
                        : ((b = 'undefined' != typeof document.onmousewheel ? 'mousewheel' : 'DOMMouseScroll'),
                          p(h, b, d, e || !1),
                          'DOMMouseScroll' == b && p(h, 'MozMousePixelScroll', d, e || !1))
                    : h.addEventListener
                    ? (f.cantouch &&
                      ...
                      a._bind(h, c, d, e || !1),
                      f.cantouch && 'mouseup' == c && a._bind(h, 'touchcancel', d, e || !1))
            ...
            a.opt.smoothscroll
                ? a.ishwscroll && f.hastransition && a.opt.usetransition && a.opt.smoothscroll
                    ? ((this.prepareTransition = function (b, c) {
                          var d = c ? (20 < b ? b : 0) : a.getTransitionSpeed(b),
                              e = d ? f.prefixstyle + 'transform ' + d + 'ms ease-out' : '';
                          (a.lasttransitionstyle && a.lasttransitionstyle == e) ||
                              ((a.lasttransitionstyle = e), a.doc.css(f.transitionstyle, e));
                          return d;
                      }),
                      ...
                      (this.doScrollPos = function (b, c, d) {
                          ...
                          a.timer = setTimeout(function () {
                              ...
                              0 < h &&
                                  ...
                                  f.transitionend
                                      ? a.scrollendtrapped ||
                                        ((a.scrollendtrapped = !0), a.bind(a.doc, f.transitionend, a.onScrollTransitionEnd, !1))
                                      : (a.scrollendtrapped && clearTimeout(a.scrollendtrapped),
                                        (a.scrollendtrapped = setTimeout(a.onScrollTransitionEnd, h))),
                                  (a.timerscroll = {
                                      bz: new B(d, a.newscrolly, h, 0, 0, 0.58, 1),
                                      bh: new B(e, a.newscrollx, h, 0, 0, 0.58, 1)
                                  }),
                                  a.cursorfreezed ||
                    ...
                    : ((this.doScrollLeft = function (b, c) {
                      ...
                      (this.doScrollPos = function (b, c, d) {
                          function f() {
                              ...
                              2 == b
                                  ? ((a.timer = 0),
                                    ...
                                    d != a.newscrollx || e != a.newscrolly ? a.doScrollPos(d, e) : a.onscrollend && a.triggerScrollEnd())
                                  : (a.timer = u(f) || 1);
                          }
                          ...
                          var n = 0,
                              p = k;
                          0 == a.dst.x
                              ? ((n = e), (p = c), (a.dst.ay = 1), (a.dst.py = 0))
                              : 0 == a.dst.y && ((n = h), (p = b), (a.dst.ax = 1), (a.dst.px = 0));
                ...
                if ((c.speedy && d && c.speedy) || e) {
                    ...
                    var f = c.lastscrollx,
                        ...
                        v = function () {
                            ...
                            c.speedx &&
                                ((f = Math.floor(c.lastscrollx - c.speedx * (1 - c.demulxy))), (c.lastscrollx = f), 0 > f || f > a) &&
                                (d = 0.1);
                            c.speedy &&
                                ((t = Math.floor(c.lastscrolly - c.speedy * (1 - c.demulxy))), (c.lastscrolly = t), 0 > t || t > q) &&
                                (d = 0.1);
