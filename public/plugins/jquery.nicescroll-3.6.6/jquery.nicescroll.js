...
(function (factory) {
    ...
    var getBrowserDetection = function () {
        ...
        d.haspointerlock =
            'pointerLockElement' in document || 'webkitPointerLockElement' in document || 'mozPointerLockElement' in document;
    ...
    var NiceScrollClass = function (myopt, me) {
        ...
        this.isrtlmode =
            this.opt.rtlmode == 'auto'
                ? (this.win[0] == window ? this.body : this.win).css('direction') == 'rtl'
                : this.opt.rtlmode === true;
                                ...
                                if (self.rail.drag && self.rail.drag.pt == 1) {
                                    ...
                                    if (self.rail.drag.hr) {
                                        if (self.hasreversehr) {
                                            self.doScrollLeft(
                                                self.scrollvaluemaxw - Math.round(self.scroll.x * self.scrollratio.x),
...
*/
                    ...
                    self.observerbody = new ClsMutationObserver(function (mutations) {
                        mutations.forEach(function (mut) {
                            if (mut.type == 'attributes') {
                                return $('body').hasClass('modal-open') && !$.contains($('.modal-dialog')[0], self.doc[0])
                                    ? self.hide()
        ...
        this.onResize = function (e, page) {
            ...
            self.scrollvaluemax =
                self.view.h - self.cursorheight - self.cursor.hborder - (self.opt.railpadding.top + self.opt.railpadding.bottom); //**

            if (self.railh) {
                self.railh.width = self.page.maxh > 0 ? self.view.w - self.rail.width : self.view.w;
                self.scrollvaluemaxw =
                    self.railh.width - self.cursorwidth - self.cursorh.wborder - (self.opt.railpadding.left + self.opt.railpadding.right); //**
            }
