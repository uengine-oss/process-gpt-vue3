(function (q) {
    ...
    function Cd(a) {
        a.display.scrollbars &&
            (a.display.scrollbars.clear(), a.display.scrollbars.addClass && kb(a.display.wrapper, a.display.scrollbars.addClass));
    ...
    function Lc(a, b) {
        ...
        0 == e.view.length || f >= e.viewTo || g <= e.viewFrom
            ...
            : (e.viewFrom > f ? (e.view = Nb(a, f, e.viewFrom).concat(e.view)) : e.viewFrom < f && (e.view = e.view.slice(Ca(a, f))),
              (e.viewFrom = f),
              e.viewTo < g ? (e.view = e.view.concat(Nb(a, e.viewTo, g))) : e.viewTo > g && (e.view = e.view.slice(0, Ca(a, g))));
        e.viewTo = g;
    ...
    function Lb(a) {
        ...
        for (var b = a.lineDiv.offsetTop, c = 0; c < a.view.length; c++) {
            ...
            if (!d.hidden) {
                ...
                f = d.line.height - e;
                2 > e && (e = xa(a));
                if (0.001 < f || -0.001 > f) if ((ca(d.line, e), Nd(d.line), d.rest)) for (e = 0; e < d.rest.length; e++) Nd(d.rest[e]);
            }
        }
    }
    function Nd(a) {
                ...
                for (b = 0; b < a.options.gutters.length; ++b)
                    (c = a.options.gutters[b]),
                        (f = e.hasOwnProperty(c) && e[c]) &&
                            g.appendChild(
                                t('div', [f], 'CodeMirror-gutter-elt', 'left: ' + d.gutterLeft[c] + 'px; width: ' + d.gutterWidth[c] + 'px')
                            );
        }
    }
    function vf(a, b, c, d) {
    ...
    function rb(a, b, c, d) {
        return (a.cm && a.cm.display.shift) || a.extend
            ? ((a = b.anchor), d && ((b = 0 > y(c, a)), b != 0 > y(d, a) ? ((a = c), (c = d)) : b != 0 > y(c, d) && (c = d)), new z(a, c))
            : new z(d || c, c);
    }
    function Ub(a, b, c, d) {
    ...
    function de(a, b) {
        b.equals(a.sel) ||
            ((a.sel = b), a.cm && ((a.cm.curOp.updateInput = a.cm.curOp.selectionChanged = !0), fe(a.cm)), L(a, 'cursorActivity', a));
    }
    function ge(a) {
    ...
    function zf(a, b, c) {
        ...
        function e(b, c, e) {
            ...
            Af(Y(f), c || 0, null == e ? h : e, function (g, q, t) {
                ...
                g == q
                    ? ((v = u), (t = w = u.left))
                    : ((v = Yb(a, r(b, q - 1), 'div', f, 'right')), 'rtl' == t && ((t = u), (u = v), (v = t)), (t = u.left), (w = v.right));
                null == c && 0 == g && (t = l);
    ...
    function cd(a, b, c, d) {
        ...
        if ('page' == d || 'window' == d)
            (a = a.display.lineSpace.getBoundingClientRect()),
                (b += a.top + ('window' == d ? 0 : window.pageYOffset || (document.documentElement || document.body).scrollTop)),
                (d = a.left + ('window' == d ? 0 : window.pageXOffset || (document.documentElement || document.body).scrollLeft)),
                (c.left += d),
                (c.right += d);
        c.top += b;
        c.bottom += b;
    ...
    function ma(a, b, c, d, e, f) {
        ...
        function h(a, b) {
            ...
            a == dd(c) && b && c.level < k[b - 1].level
                ...
                : a == ed(c) && b < k.length - 1 && c.level < k[b + 1].level && ((c = k[++b]), (a = dd(c) - (c.level % 2)), (d = !1));
    ...
    function Q(a, b, c, d) {
        ...
        if (b >= e.viewTo) ra && Mc(a.doc, b) < e.viewTo && qa(a);
            ...
            var f = dc(a, b, b, -1),
                g = dc(a, c, c + d, 1);
            f && g
                ? ((e.view = e.view.slice(0, f.index).concat(Nb(a, f.lineN, g.lineN)).concat(e.view.slice(g.index))), (e.viewTo += d))
                : qa(a);
        }
    ...
    function Nf(a, b, c, d, e) {
                ...
                if (((x = b), 'rect' == d)) {
                    ...
                    (e = m),
                        ...
                        'single' != d &&
                            ...
                            0 < y(b.anchor, f) ? ((k = b.head), (f = Qb(e.from(), b.anchor))) : ((k = b.anchor), (f = Pb(e.to(), b.head)))),
                        (e = n.ranges.slice(0)),
                        (e[p] = new z(w(l, f), k)),
                        H(l, Z(e, p), kd);
        }
        ...
        if (b.altKey) (d = 'rect'), e || (m = new z(c, c)), (c = Ua(a, b, !0, !0)), (p = -1);
            ...
            'triple' == d
                ? ((t = new z(r(c.line, 0), w(l, r(c.line + 1, 0)))), (m = a.display.shift || l.extend ? rb(l, m, t.anchor, t.head) : t))
                : (m = rb(l, m, c));
        e
            ? -1 == p
    ...
    function kc(a, b, c) {
        if (!a.cm || !a.cm.state.suppressEdits) {
            for (
                var d = a.history, e, f = a.sel, g = 'undo' == b ? d.done : d.undone, h = 'undo' == b ? d.undone : d.done, k = 0;
    ...
    function Sd(a, b) {
        ...
        for (var d = 0; d <= (b.rest ? b.rest.length : 0); d++) {
            ...
            0 == d
                ...
                : ((b.measure.maps || (b.measure.maps = [])).push(c.map), (b.measure.caches || (b.measure.caches = [])).push({}));
        }
    ...
    function cg(a, b, c, d, e, f, g) {
        if (b) {
            ...
            if (c || d || e || l || g)
                return (
                    (b = c || ''), d && (b += d), e && (b += e), (d = t('span', [m], b, g)), f && (d.title = f), a.content.appendChild(d)
                );
            ...
            init: function (a) {
                function b(a) {
                    if (d.somethingSelected())
                        (X = d.getSelections()),
                            c.inaccurateSelection && ((c.prevInput = ''), (c.inaccurateSelection = !1), (f.value = X.join('\n')), Za(f));
            ...
            showPrimarySelection: function () {
                ...
                if (!c || c.bad || !d || d.bad || 0 != y(Qb(c, d), b.from()) || 0 != y(Pb(c, d), b.to()))
                    if (((c = Yd(this.cm, b.from())), (d = Yd(this.cm, b.to())), c || d)) {
                        ...
                        f &&
                            (a.removeAllRanges(), a.addRange(f), b && null == a.anchorNode ? a.addRange(b) : wa && this.startGracePeriod());
    ...
    q.prototype = {
        ...
        addWidget: function (a, b, c, d, e) {
            ...
            'right' == e
                ...
                : ('left' == e ? (h = 0) : 'middle' == e && (h = (f.sizer.clientWidth - b.offsetWidth) / 2), (b.style.left = h + 'px'));
            c &&
        ...
        findPosV: function (a, b, c, d) {
            ...
            for (
                a = w(this.doc, a);
                f < b && ((a = ma(this, a, 'div')), null == d ? (d = a.left) : (a.left = d), (a = Pe(this, a, e, c)), !a.hitSide);
                ++f
            );
            return a;
        },
    ...
    x(
        ...
        function (a) {
            a.options.lineWrapping
                ? (mb(a.display.wrapper, 'CodeMirror-wrap'), (a.display.sizer.style.minWidth = ''), (a.display.sizerWidth = null))
