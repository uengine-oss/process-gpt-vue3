                            ...
                            (function () {
                                for (
                                    ...
                                    for (var b = c[f], h = [], k = b.items, m = k.length, d = 0; d < m; d++) {
                                        ...
                                        r.match(p) ||
                                            h.push('\x3cdt\x3e%1\x3c/dt\x3e\x3cdd\x3e%2\x3c/dd\x3e'.replace('%1', q.name).replace('%2', r));
                                    }
                                    g.push(
                                        '\x3ch1\x3e%1\x3c/h1\x3e\x3cdl\x3e%2\x3c/dl\x3e'.replace('%1', b.name).replace('%2', h.join(''))
                                    );
                                }
