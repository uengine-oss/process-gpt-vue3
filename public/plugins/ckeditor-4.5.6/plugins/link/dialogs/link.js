        ...
        return {
                                        ...
                                        },
                                        {
                                            ...
                                            validate: function () {
                                                ...
                                                return a.getContentElement('info', 'linkType') && 'url' != a.getValueOf('info', 'linkType')
                                                    ? !0
                                                    : !g.config.linkJavaScriptLinksAllowed && /javascript\:/.test(this.getValue())
            ...
            onOk: function () {
                ...
                if (this._.selectedElement) {
                    ...
                    (b = b.getRanges()[0]),
                        b.collapsed &&
                            ((a = new CKEDITOR.dom.text('email' == a.type ? a.email.address : c.set['data-cke-saved-href'], g.document)),
                            b.insertNode(a),
