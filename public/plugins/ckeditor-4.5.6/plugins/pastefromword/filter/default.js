                    ...
                    for (q = 0; q < a.length; q++)
                        if (
                            ...
                            for (k = 0; k < y; k++)
                                if (
                                    ((g = u[k]),
                                    g.attributes.value && Number(g.attributes.value) == k + 1 && delete g.attributes.value,
                    ...
                    return function (b, f) {
                        ...
                        (b || '').replace(/&quot;/g, '"').replace(/\s*([^ :;]+)\s*:\s*([^;]+)\s*(?=;|$)/g, function (b, e, g) {
                            ...
                            for (var n, h, p, m = 0; m < a.length; m++)
                                if (
                                    a[m] &&
                                    ((b = a[m][0]), (n = a[m][1]), (h = a[m][2]), (p = a[m][3]), e.match(b) && (!n || g.match(n)))
                                ) {
                                    e = p || e;
                                    c && (h = h || g);
                    ...
                    elements: {
                        ...
                        font: function (a) {
                            if (t(a.parent)) delete a.name;
                                ...
                                var b = a.attributes,
                                    ...
                                    e = a.parent;
                                'font' == e.name
                                    ? (CKEDITOR.tools.extend(e.attributes, a.attributes), d && e.addStyle(d), delete a.name)
                                    : ((d = (d || '').split(';')),
                                      b.color && ('#000000' != b.color && d.push('color:' + b.color), delete b.color),
                                      b.face && (d.push('font-family:' + b.face), delete b.face),
                                      b.size &&
                                          (d.push('font-size:' + (3 < b.size ? 'large' : 3 > b.size ? 'small' : 'medium')), delete b.size),
                                      (a.name = 'span'),
                                      a.addStyle(d.join(';')));
                            }
                        },
                        ...
                        a: function (a) {
                            ...
                            b.name && b.name.match(/ole_link\d+/i)
                                ? delete a.name
                                : b.href && b.href.match(/^file:\/\/\/[\S]+#/i) && (b.href = b.href.replace(/^file:\/\/\/[^#]+/i, ''));
                        },
                        ...
                        : function (a, b) {
                              ...
                              return d
                                  ...
                                  ? ((c = CKEDITOR.htmlParser.fragment.fromHtml(c[0]).children[0]),
                                    (d = (d = (d = b.previous) && d.value.match(/<v:imagedata[^>]*o:href=['"](.*?)['"]/)) && d[1]) &&
                                        (c.attributes.src = d),
                                    c)
                                  : !1;
                          }
