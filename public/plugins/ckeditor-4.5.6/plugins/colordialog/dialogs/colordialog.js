...
CKEDITOR.dialog.add('colordialog', function (x) {
    ...
    function y(a) {
        ...
        'td' == a.getName() &&
            ...
            ((l = a), l.setAttribute('aria-selected', !0), t.getContentElement('picker', 'selectedColor').setValue(c));
    }
    function C(a) {
        a = a.replace(/^#/, '');
        for (var c = 0, b = []; 2 >= c; c++) b[c] = parseInt(a.substr(2 * c, 2), 16);
        return '#' + (165 <= 0.2126 * b[0] + 0.7152 * b[1] + 0.0722 * b[2] ? '000' : 'fff');
    }
    function z(a) {
        ...
        'td' == b.getName() &&
            ...
            (u(a),
            c ? (e = b) : (A = b),
            c && (b.setStyle('border-color', C(g)), b.setStyle('border-style', 'dotted')),
            d.getById(m).setStyle('background-color', g),
            d.getById(n).setHtml(g));
    }
    function u(a) {
        ...
        e || A || (d.getById(m).removeStyle('background-color'), d.getById(n).setHtml('\x26nbsp;'));
    }
    function D(a) {
        var c = a.data,
            b = c.getTarget(),
    ...
    var v = CKEDITOR.dom.element,
        d = CKEDITOR.document,
        f = x.lang.colordialog,
        t,
        B = { type: 'html', html: '\x26nbsp;' },
        l,
        e,
        A,
        p = function (a) {
    ...
    (function () {
        ...
        h = CKEDITOR.dom.element.createFromHtml(
            '\x3ctable tabIndex\x3d"-1" aria-label\x3d"' +
                f.options +
                        ...
                        children: [
                            ...
                            B,
                            {
                                ...
                                children: [
                                    ...
                                    B,
                                    { type: 'button', id: 'clear', label: f.clear, onClick: q }
                                ]
                            }
                        ]
                    }
