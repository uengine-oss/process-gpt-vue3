...
(function (t) {
    ...
    function a() {
        t.datepicker._isDisabledDatepicker(_.inline ? _.dpDiv.parent()[0] : _.input[0]) ||
                ...
                (t.fn.position = function (n) {
                    ...
                    return (
                        ...
                        this.each(function () {
                            ...
                            'right' === n.my[0] ? (I.left -= u) : 'center' === n.my[0] && (I.left -= u / 2),
                                'bottom' === n.my[1] ? (I.top -= d) : 'center' === n.my[1] && (I.top -= d / 2),
                                (I.left += M[0]),
                                (I.top += M[1]),
                        ...
                        this.selectees.each(function () {
                            ...
                            i &&
                                ...
                                ('touch' === n.tolerance
                                    ...
                                    : 'fit' === n.tolerance && (l = i.left > o && r > i.right && i.top > a && h > i.bottom),
                                l
        ...
        t.widget('ui.menu', {
            ...
            blur: function (t, e) {
                e || clearTimeout(this.timer),
                    this.active &&
                        (this.active.removeClass('ui-state-focus'), (this.active = null), this._trigger('blur', t, { item: this.active }));
            },
    ...
    t.extend(n.prototype, {
                                ...
                                (E +=
                                    ...
                                    (F && !_
                                        ...
                                        : ' ' +
                                          ...
                                          (A.getTime() === Y.getTime() ? ' ui-datepicker-today' : '')) +
                                    "'" +
                                    ...
                                    (F && !_
                                        ...
                                        : "<a class='ui-state-default" +
                                          (A.getTime() === Y.getTime() ? ' ui-state-highlight' : '') +
                ...
                this.valueDiv
                    ...
                    this.indeterminate
                        ? (this.element.removeAttr('aria-valuenow'),
                          this.overlayDiv || (this.overlayDiv = t("<div class='ui-progressbar-overlay'></div>").appendTo(this.valueDiv)))
        ...
        t.widget('ui.selectmenu', {
            ...
            close: function (t) {
                this.isOpen &&
                    ((this.isOpen = !1), this._toggleAttr(), (this.range = null), this._off(this.document), this._trigger('close', t));
            },
            widget: function () {
                return this.button;
            },
        ...
        t.widget('ui.slider', t.ui.mouse, {
            ...
            _createHandles: function () {
                var e,
                    ...
                    a = [];
                for (
                    i = (s.values && s.values.length) || 1, n.length > i && (n.slice(i).remove(), (n = n.slice(0, i))), e = n.length;
                    i > e;
                    e++
                )
                    a.push(o);
        ...
        t.widget('ui.tabs', {
            ...
            _setOption: function (t, e) {
                return 'active' === t
                    ...
                    : (this._super(t, e),
                      'collapsible' === t &&
                          (this.element.toggleClass('ui-tabs-collapsible', e), e || this.options.active !== !1 || this._activate(0)),
    ...
    (t.effects = { effect: {} }),
        ...
        (t.effects.effect.bounce = function (e, i) {
            ...
            for (
                (c || l) && r.push('opacity'),
                    ...
                    d || (d = a['top' === _ ? 'outerHeight' : 'outerWidth']() / 3),
                    c &&
                        ((o = { opacity: 1 }),
                        (o[_] = 0),
                        a
                ...
                (n = {}), (n[_] = (v ? '-=' : '+=') + d), a.animate(n, g, m).animate(o, g, m), (d = l ? 2 * d : d / 2);
            l && ((n = { opacity: 0 }), (n[_] = (v ? '-=' : '+=') + d), a.animate(n, g, m)),
                a.queue(function () {
        ...
        (t.effects.effect.fold = function (e, i) {
            ...
            t.effects.save(o, a),
                ...
                (m[f[0]] = h ? n[0] : c),
                (_[f[1]] = h ? n[1] : 0),
                s.animate(m, g, e.easing).animate(_, g, e.easing, function () {
        ...
        (t.effects.effect.scale = function (e, i) {
            ...
            (n.effect = 'size'),
                ...
                (n.to = { height: l.height * c.y, width: l.width * c.x, outerHeight: l.outerHeight * c.y, outerWidth: l.outerWidth * c.x }),
                n.fade &&
        ...
        (t.effects.effect.shake = function (e, i) {
            ...
            n
                ...
                v > 1 && _.splice.apply(_, [1, 0].concat(_.splice(v, c + 1))),
                n.dequeue();
        }),
