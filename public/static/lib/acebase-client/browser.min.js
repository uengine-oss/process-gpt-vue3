    ...
    })()(
        {
                            ...
                            class AceBaseClient extends acebase_core_1.AceBaseBase {
                                constructor(init) {
                                    ...
                                    if (typeof init !== 'object') {
                                        ...
                                        init = { host: host, port: port, dbname: dbname, https: https };
                                    }
                                    const settings = new ConnectionSettings(init);
                                    ...
                                    this.on('connect', () => {
                                        if (
                                            ...
                                            syncTimeout = setTimeout(syncPendingChanges, 2500);
                                        }
                                    });
                                    this.on('signin', () => {
                                ...
                                get cache() {
                                    ...
                                    const update = (path = '', cursor = null) => this.api.updateCache(path, cursor);
                                    ...
                                    return { clear: clear, update: update, get: get };
                                }
                            }
                ...
                function (require, module, exports) {
                    ...
                    class WebApi extends acebase_core_1.Api {
                        constructor(dbname = 'default', settings, callback) {
                            ...
                            this.dbname = dbname;
                            this.settings = settings;
                            this._id = acebase_core_1.ID.generate();
                            this.socket = null;
                            this._serverVersion = 'unknown';
                            this._cursor = { current: null, sync: null };
                            ...
                            if (settings.cache.enabled !== false) {
                                this._cache = { db: settings.cache.db, priority: settings.cache.priority };
                            }
                            if (settings.network.monitor) {
                                const interval = setInterval(() => this.checkConnection(), settings.network.interval * 1e3);
                        ...
                        connect(retry = true) {
                            ...
                            return new Promise((resolve, reject) => {
                                ...
                                socket.on('data-event', (data) => {
                                    ...
                                    this._updateCursor(context.acebase_cursor);
                                    const causedByUs =
                                    ...
                                    if (updateCache) {
                                        if (data.path.startsWith('__')) {
                                            ...
                                            mutations.forEach((m) => {
                                                ...
                                                this.cache.db.api.set(path, m.val, { suppress_events: !fireCacheEvents, context: context });
                                            });
                                        } else if (data.event === 'notify_child_removed') {
                                            this.cache.db.api.set(
                                                acebase_core_1.PathInfo.getChildPath(`${this.dbname}/cache`, data.path),
                                                null,
                                                { suppress_events: !fireCacheEvents, context: context }
                                            );
                        ...
                        async subscribe(path, event, callback, settings) {
                            ...
                            if (event === 'mutated') {
                                Object.keys(this._subscriptions)
                                    ...
                                    .map((path) =>
                                        _websocketRequest(this.socket, 'unsubscribe', { path: path, event: 'mutated' }, this.accessToken)
                                    )
                        ...
                        async unsubscribe(path, event, callback) {
                            ...
                            if (pathSubs.length === 0) {
                                ...
                                promise = _websocketRequest(
                                    this.socket,
                                    'unsubscribe',
                                    { path: path, event: event, access_token: this.accessToken },
                                    this.accessToken
                                ).catch((err) =>
                        ...
                        transaction(path, callback, options = { context: {} }) {
                            ...
                            return new Promise(async (resolve, reject) => {
                                ...
                                if (this.isConnected && ((_a = this.settings.network) === null || _a === void 0 ? void 0 : _a.realtime)) {
                                    ...
                                    const startData = JSON.stringify({ path: path });
                                    try {
                                        ...
                                        const finishData = JSON.stringify({ id: id, value: acebase_core_1.Transport.serialize(newValue) });
                                        const { context: context } = await this._request({
                                            ignoreConnectionState: true,
                                            method: 'POST',
                        ...
                        async _request(options) {
                            ...
                            if (this.isConnected || options.ignoreConnectionState === true) {
                                ...
                                await (0, promise_timeout_1.promiseTimeout)(connectPromise, 1e3, 'Waiting for connection').catch((err) => {
                                    throw new Error(error_1.NOT_CONNECTED_ERROR_MESSAGE);
                                });
                        ...
                        handleSignInResult(result, emitEvent = true) {
                            ...
                            (_a = this.socket) === null || _a === void 0 ? void 0 : _a.emit('signin', details.accessToken);
                        ...
                        async signIn(username, password) {
                            ...
                            const result = await this._request({
                                ...
                                data: {
                                    ...
                                    username: username,
                                    password: password,
                                    client_id: this.socket && this.socket.id
                                }
                            });
                        ...
                        async signInWithEmail(email, password) {
                            ...
                            const result = await this._request({
                                method: 'POST',
                                url: `${this.url}/auth/${this.dbname}/signin`,
                                data: { method: 'email', email: email, password: password, client_id: this.socket && this.socket.id }
                            });
                            return this.handleSignInResult(result);
                        }
                        ...
                        async changePassword(uid, currentPassword, newPassword) {
                            ...
                            const result = await this._request({
                                ...
                                data: { uid: uid, password: currentPassword, new_password: newPassword }
                            });
                            this.accessToken = result.access_token;
                        ...
                        async sync(options = { firstSync: false, fetchFreshData: true, eventCallback: null }) {
                            ...
                            try {
                                ...
                                if (this.hasCache) {
                                    ...
                                    const { value: value, context: context } = await cacheApi.get(`${this.dbname}/pending`);
                                    const pendingChanges = value;
                                    cacheApi.set(`${this.dbname}/stats/last_sync_start`, new Date()).catch(handleStatsUpdateError);
                                    try {
                                        const ids = Object.keys(pendingChanges || {}).sort();
                                        ...
                                        for (const m of mutations) {
                                            ...
                                            try {
                                                ...
                                                cacheApi.update(`${this.dbname}/pending`, updates);
                                            } catch (err) {
                                                ...
                                                ids.forEach((id) => {
                                                    cacheApi.transaction(`${this.dbname}/pending/${id}`, (m) => {
                                                        if (!m.error) {
                                                            m.error = { first: errorReport, last: errorReport, retries: 0 };
                                                        } else {
                                ...
                                if (this.hasCache) {
                                    ...
                                    const strategy = { reload: [], cursor: [], fallback: [], warn: [], noop: [] };
                                    ...
                                    strategy.cursor = !cursor
                                        ...
                                        : subscriptionPaths
                                              ...
                                              .reduce((cursorItems, path) => {
                                                  ...
                                                  events.length > 0 && cursorItems.push({ path: path, events: events });
                                                  return cursorItems;
                                              }, []);
                                    ...
                                    if (strategy.cursor.length > 0) {
                                        ...
                                        const cursorPromise = (async () => {
                                            let remoteMutations;
                                            try {
                                                const result = await this.getChanges({ for: strategy.cursor, cursor: cursor });
                                    ...
                                    if (strategy.reload.length > 0) {
                                        ...
                                        const reloadPromise = (async () => {
                                            const promises = strategy.reload.map((path) => {
                                                ...
                                                return this.get(path, { cache_mode: 'bypass' }).catch((err) => {
                                ...
                                const info = {
                                    local: totalPendingChanges,
                                    remote: totalRemoteChanges,
                                    method: usedSyncMethod,
                                    cursor: cursor
                                };
                        ...
                        async getMutations(filter) {
                            ...
                            const query = Object.keys(filter)
                                ...
                                .filter((p) => p != null)
                                .join('&');
                            const { data: data, context: context } = await this._request({
                        ...
                        async _addCacheSetMutation(path, value, context) {
                            ...
                            const re = new RegExp(`^${escapedPath}(?:\\[|/|$)`);
                        ...
                        set(path, value, options = { allow_cache: true, context: {} }) {
                            ...
                            const updateServer = async () => {
                                ...
                                Object.assign(options.context, context);
                        ...
                        update(path, updates, options = { allow_cache: true, context: {} }) {
                            ...
                            const addPendingTransaction = async () => {
                                ...
                                const mutations = Object.keys(updates).map((prop) => {
                                    ...
                                    return { path: pathInfo.childPath(prop), value: updates[prop] };
                                });
                        ...
                        async get(path, options = { cache_mode: 'allow' }) {
                            ...
                            const getServerValue = async () => {
                                ...
                                const result = await this._request({ url: url, includeContext: true });
                                ...
                                return { value: value, context: context, cursor: cursor };
                            };
                            const getCacheValue = async (throwOnNull = false) => {
                                ...
                                let { value: value, context: context } = result;
                            ...
                            if (options.cache_mode === 'force') {
                                const { value: value, context: context } = await getCacheValue(false);
                            ...
                            if (useCache && typeof options.cache_cursor === 'string') {
                                ...
                                return { value: value, context: context, cursor: context.acebase_cursor };
                            }
                            if (!useCache) {
                                const { value: value, context: context, cursor: cursor } = await getServerValue();
                            ...
                            if (!this.isConnected || ((_a = this._cache) === null || _a === void 0 ? void 0 : _a.priority) === 'cache') {
                                ...
                                const { value: value, context: context } = await getCacheValue(throwOnNull);
                                context.acebase_origin = 'cache';
                                return { value: value, context: context };
                            }
                            return new Promise((resolve, reject) => {
                                ...
                                const gotValue = (source, val) => {
                                    ...
                                    const { value: value, context: context, cursor: cursor } = val;
                                    if (source === 'server') {
                                        done = true;
                                        this.debug.verbose(`Using server value for "${path}"`);
                                        context.acebase_origin = 'server';
                                        resolve({ value: value, context: context, cursor: cursor });
                                    } else if (value === null) {
                                        if (!wait) {
                                            const serverError =
                                        ...
                                        context.acebase_origin = 'cache';
                                        resolve({ value: value, context: context });
                                    } else {
                                        setTimeout(() => {
                                            if (done) {
                                                return;
                        ...
                        exists(path, options = { allow_cache: true }) {
                            ...
                            const getServerExists = () =>
                                this._request({ url: `${this.url}/exists/${this.dbname}/${path}` })
                                    .then((res) => res.exists)
                                    .catch((err) => {
                                        throw err;
                                    });
                        ...
                        callExtension(method, path, data) {
                            ...
                            return this._request({ method: method, url: url, data: postData, ignoreConnectionState: true });
                        }
                        ...
                        async updateCache(path = '', cursor) {
                            ...
                            if (loadValue) {
                                const { value: value, context: context } = await this.get(path, { cache_mode: 'bypass' });
                                return {
                                    path: path,
                                    used_cursor: cursor,
                                    new_cursor: context.acebase_cursor,
                            ...
                            const { changes: changes, new_cursor: new_cursor } = await this.getChanges({ path: path, cursor: cursor });
                            ...
                            return { path: path, used_cursor: cursor, new_cursor: new_cursor, loaded_value: false, changes: changes };
                        }
                        async query(
                            path,
                            query,
                            ...
                            if (useCache) {
                                ...
                                let { results: results, context: context } = data;
                                ...
                                context.acebase_origin = 'cache';
                                delete context.acebase_cursor;
                                return { results: results, context: context, stop: stop };
                            }
                            const request = { query: query, options: options };
                            if (
                                ...
                                this._realtimeQueries[request.query_id] = { query: query, options: options };
                            }
                            ...
                            try {
                                ...
                                return { results: results.list, context: context, stop: stop };
                            } catch (err) {
                                throw err;
                            }
                        }
                        async createIndex(path, key, options) {
                            ...
                            if (version.length === 3 && +version[0] >= 1 && +version[1] >= 10) {
                                const data = JSON.stringify({ path: path, key: key, options: options });
                                return await this._request({ method: 'POST', url: `${this.url}/index/${this.dbname}/create`, data: data });
                            } else {
                                const data = JSON.stringify({ action: 'create', path: path, key: key, options: options });
                                return await this._request({ method: 'POST', url: `${this.url}/index/${this.dbname}`, data: data });
                            }
                        }
                        getIndexes() {
                        ...
                        async deleteIndex(fileName) {
                            ...
                            if (version.length === 3 && +version[0] >= 1 && +version[1] >= 10) {
                                ...
                                return this._request({ method: 'POST', url: `${this.url}/index/${this.dbname}/delete`, data: data });
                            } else {
                        ...
                        reflect(path, type, args) {
                            ...
                            if (typeof args === 'object') {
                                const query = Object.keys(args).map((key) => `${key}=${args[key]}`);
                                if (query.length > 0) {
                                    url += `&${query.join('&')}`;
                                }
                            }
                        ...
                        export(path, write, options = { format: 'json', type_safe: true }) {
                            ...
                            return this._request({ url: url, dataReceivedCallback: (chunk) => write(chunk) });
                        }
                        import(path, read, options = { format: 'json', suppress_events: false }) {
                            ...
                            return this._request({ method: 'POST', url: url, dataRequestCallback: (length) => read(length) });
                        }
                        get serverPingUrl() {
                        ...
                        setSchema(path, schema) {
                            ...
                            const data = JSON.stringify({ action: 'set', path: path, schema: schema });
                            return this._request({ method: 'POST', url: `${this.url}/schema/${this.dbname}`, data: data });
                        }
                        getSchema(path) {
                ...
                function (require, module, exports) {
                    ...
                    class AceBaseClientAuth {
                        ...
                        async finishAuthProviderSignIn(callbackResult) {
                            ...
                            return { user: this.user, accessToken: this.accessToken, provider: details.provider };
                        }
                        async refreshAuthProviderToken(providerName, refreshToken) {
                            if (!this.client.isReady) {
                                await this.client.ready();
                        ...
                        async signOut(options = { everywhere: false, clearCache: false }) {
                            if (!this.client.isReady) {
                                await this.client.ready();
                            } else if (!this.user) {
                            ...
                            this.user = null;
                            this.eventCallback('signout', { source: 'signout', user: user });
                        }
                        ...
                        async updateUserSettings(settings) {
                            return await this.updateUserDetails({ settings: settings });
                        }
                        async signUp(details) {
                            ...
                            if (this.user && !isAdmin) {
                                const user = this.user;
                                this.user = null;
                                this.eventCallback('signout', { source: 'signup', user: user });
                            }
                        ...
                        async deleteAccount(uid) {
                            ...
                            if (signOut) {
                                ...
                                const user = this.user;
                                this.user = null;
                                this.eventCallback('signout', { source: 'delete_account', user: user });
                            }
                        }
                    }
            ...
            5: [
                function (require, module, exports) {
                    ...
                    window.AceBaseClient = acebaseclient.AceBaseClient;
            ...
            10: [
                function (require, module, exports) {
                    ...
                    async function request(
                        ...
                        const headers = { 'AceBase-Context': JSON.stringify(options.context || null) };
                        const init = { method: method, headers: headers, body: undefined };
                        ...
                        const request = { url: url, method: method, headers: headers, body: undefined };
                        ...
                        if (res.status === 200) {
                            ...
                            const response = { statusCode: res.status, statusMessage: res.statusText, headers: res.headers, body: data };
                            let code = res.status,
            ...
            11: [
                function (require, module, exports) {
                    ...
                    exports.NOT_CONNECTED_ERROR_MESSAGE = 'remote database is not connected';
                },
                {}
            ],
            12: [
                function (require, module, exports) {
                    ...
                    function biasChanged() {
                        ...
                        acebase_core_1.ID.timeBias = time.bias;
                    }
                    const interval = 1e4;
                    function checkLocalTime() {
                        const now = Date.now(),
                            perf = performance_1.default.now(),
                            msPassed = perf - time.lastPerf,
                            expected = time.lastTime + Math.round(msPassed),
                            diff = expected - now;
                        if (Math.abs(diff) > 1) {
            ...
            14: [
                function (require, module, exports) {
                    ...
                    class AceBaseBase extends simple_event_emitter_1.SimpleEventEmitter {
                        ...
                        get indexes() {
                            return {
                                get: () => this.api.getIndexes(),
                                create: (path, key, options) => this.api.createIndex(path, key, options),
                                delete: async (filePath) => this.api.deleteIndex(filePath)
                            };
                        }
                        get schema() {
                            return {
                                get: (path) => this.api.getSchema(path),
                                set: (path, schema) => this.api.setSchema(path, schema),
                                all: () => this.api.getSchemas(),
                                check: (path, value, isUpdate) => this.api.validateSchema(path, value, isUpdate)
                            };
                        }
                    }
                ...
                function (require, module, exports) {
                    ...
                    class LiveDataProxy {
                        static async create(ref, options) {
                            var _a;
                            ref = new data_reference_1.DataReference(ref.db, ref.path);
                            let cache,
                                loaded = false;
                            let latestCursor = options === null || options === void 0 ? void 0 : options.cursor;
                            let proxy;
                            const proxyId = id_1.ID.generate();
                            ...
                            const subscription = ref.on('mutations', { syncFallback: syncFallback }).subscribe(async (snap) => {
                                var _a;
                                if (!loaded) {
                                    return;
                                }
                                ...
                                const proceed = mutations.every((mutation) => {
                                    ...
                                    clientEventEmitter.emit('mutation', { snapshot: changeSnap, isRemote: isRemote });
                                    return true;
                                });
                                if (proceed) {
                                    clientEventEmitter.emit('cursor', context.acebase_cursor);
                                    localMutationsEmitter.emit('mutations', { origin: 'remote', snap: snap });
                                } else {
                            ...
                            const pushLocalMutations = async () => {
                                ...
                                process_1.default.nextTick(() => {
                                    ...
                                    localMutationsEmitter.emit('mutations', { origin: 'local', snap: snap });
                                });
                                processPromise = mutations
                                    ...
                                    .reduce((updates, m) => {
                                        ...
                                        if (target.length === 0) {
                                            updates.push({ ref: ref, target: target, value: cache, type: 'set', previous: m.previous });
                                        } else {
                                    ...
                                    .reduce(async (promise, update) => {
                                        const context = { acebase_proxy: { id: proxyId, source: update.type } };
                                        await promise;
                                        await update.ref
                                            .context(context)
                            ...
                            const syncCompleted = () => {
                                ...
                                syncPromises.push({ resolve: resolve });
                                return promise;
                            };
                            ...
                            const flagOverwritten = (target) => {
                                if (!mutationQueue.find((m) => RelativeNodeTarget.areEqual(m.target, target))) {
                                    mutationQueue.push({
                                        target: target,
                                        previous: (0, utils_1.cloneObject)(getTargetValue(cache, target))
                                    });
                                }
                                scheduleSync();
                            };
                            ...
                            const addOnChangeHandler = (target, callback) => {
                                ...
                                const mutationsHandler = async (details) => {
                                    var _a;
                                    const { snap: snap, origin: origin } = details;
                                    const context = snap.context();
                                    ...
                                    const mutations = snap
                                        .val(false)
                                        .filter((mutation) => mutation.target.slice(0, target.length).every((key, i) => target[i] === key));
                                    if (mutations.length === 0) {
                                        return;
                                    }
                                ...
                                clientSubscriptions.push({ target: target, stop: stop });
                                return { stop: stop };
                            };
                            const handleFlag = (flag, target, args) => {
                                if (flag === 'write') {
                                    ...
                                    const subscribe = (subscriber) => {
                                        ...
                                        const subscription = addOnChangeHandler(target, (value) => {
                                    ...
                                    return new Promise(async (resolve) => {
                                        ...
                                        const tx = { target: target, status: 'started', transaction: null };
                            ...
                            if (snap.context().acebase_origin !== 'cache') {
                                clientEventEmitter.emit('cursor', (_a = ref.cursor) !== null && _a !== void 0 ? _a : null);
                            }
                            loaded = true;
                            cache = snap.val();
                            if (
                                ...
                                const context = { acebase_proxy: { id: proxyId, source: 'default' } };
                            ...
                            return {
                                ...
                                onMutation(callback) {
                                    ...
                                    clientEventEmitter.on('mutation', ({ snapshot: snapshot, isRemote: isRemote }) => {
                                        try {
                        ...
                        const handler = {
                            get(target, prop, receiver) {
                                ...
                                const proxifyChildValue = (prop) => {
                                    ...
                                    childProxies.push({ typeof: typeof value, prop: prop, value: newChildProxy });
                                    return newChildProxy;
                                };
                                const unproxyValue = (value) =>
                                    value !== null && typeof value === 'object' && value[isProxy] ? value.getTarget() : value;
                                if (
                                ...
                                if (typeof value === 'undefined') {
                                    ...
                                    if (prop === 'forEach') {
                                        return function forEach(callback) {
                                            ...
                                            for (let i = 0; !stop && i < keys.length; i++) {
                                                const key = keys[i];
                                                const value = proxifyChildValue(key);
                                    ...
                                    if (prop === 'onChanged') {
                                        return function onChanged(callback) {
                                            return context.flag('onChange', context.target, { callback: callback });
                                        };
                                    }
                                    if (prop === 'subscribe') {
                                    ...
                                    if (isArray) {
                                        ...
                                        if (['forEach', 'every', 'some', 'filter', 'map'].includes(prop)) {
                                            return function iterate(callback) {
                                                return target[prop]((value, i) => callback(proxifyChildValue(i), i, proxy));
                                            };
                                        }
                                        if (['reduce', 'reduceRight'].includes(prop)) {
                                            return function reduce(callback, initialValue) {
                                                return target[prop](
                                                    (prev, value, i) => callback(prev, proxifyChildValue(i), i, proxy),
                                                    initialValue
                                                );
                                            };
                                        }
                                        if (['find', 'findIndex'].includes(prop)) {
                                            return function find(callback) {
                                                let value = target[prop]((value, i) => callback(proxifyChildValue(i), i, proxy));
                                                if (prop === 'find' && value) {
                                                    const index = target.indexOf(value);
                                                    value = proxifyChildValue(index);
                                                }
                                                return value;
                                            };
                                        }
                                            ...
                                            return function* generator() {
                                                for (let i = 0; i < target.length; i++) {
                                                    if (prop === 'keys') {
                                                        ...
                                                        const value = proxifyChildValue(i);
                                                        if (prop === 'entries') {
                                                            yield [i, value];
                                                        } else {
                                                            yield value;
                            ...
                            set(target, prop, value, receiver) {
                                ...
                                if (value !== null) {
                                    if (typeof value === 'object') {
                                        ...
                                        value = (0, utils_1.cloneObject)(value);
                                    }
                    ...
                    class OrderedCollectionProxy {
                        ...
                        add(item, index, from) {
                            ...
                            if (typeof from === 'number') {
                                ...
                                if (from === index) {
                                    return { key: fromKey, index: index };
                                }
            ...
            21: [
                function (require, module, exports) {
                    ...
                    class DataReference {
                        ...
                        async set(value, onComplete) {
                            try {
                                ...
                                const { cursor: cursor } = await this.db.api.set(this.path, value, { context: this[_private].context });
                                this.cursor = cursor;
                        ...
                        async update(updates, onComplete) {
                            try {
                                ...
                                if (
                                    ...
                                    const { cursor: cursor } = await this.db.api.update(this.path, updates, {
                        ...
                        async transaction(callback) {
                            ...
                            const cb = (currentValue) => {
                                ...
                                if (newValue instanceof Promise) {
                                    return newValue
                                        .then((val) => this.db.types.serialize(this.path, val))
                                        .catch((err) => {
                                            throwError = err;
                                            return;
                                        });
                            ...
                            const { cursor: cursor } = await this.db.api.transaction(this.path, cb, { context: this[_private].context });
                            this.cursor = cursor;
                            if (throwError) {
                                throw throwError;
                            }
                            ...
                            const subscribe = () => {
                                ...
                                if (!advancedOptions.newOnly) {
                                    if (event === 'value') {
                                        ...
                                        let skip = 0;
                                        const more = async () => {
                                            const children = await this.db.api.reflect(this.path, 'children', { limit: limit, skip: skip });
                        ...
                        get(optionsOrCallback, callback) {
                            if (!this.db.isReady) {
                                ...
                                return typeof optionsOrCallback !== 'function' && typeof callback !== 'function' ? promise : undefined;
                            }
                            callback =
                        ...
                        async forEach(callbackOrOptions, callback) {
                            ...
                            const summary = { canceled: false, total: info.list.length, processed: 0 };
                        ...
                        async getMutations(cursorOrDate) {
                            ...
                            const timestamp =
                                cursorOrDate === null || typeof cursorOrDate === 'undefined'
                                    ...
                                    : undefined;
                            return this.db.api.getMutations({ path: this.path, cursor: cursor, timestamp: timestamp });
                        }
                        async getChanges(cursorOrDate) {
                            ...
                            const timestamp =
                                cursorOrDate === null || typeof cursorOrDate === 'undefined'
                                    ...
                                    ? cursorOrDate.getTime()
                                    : undefined;
                            return this.db.api.getChanges({ path: this.path, cursor: cursor, timestamp: timestamp });
                        }
                    }
                    ...
                    class DataReferenceQuery {
                        constructor(ref) {
                            this.ref = ref;
                            this[_private] = { filters: [], skip: 0, take: 0, order: [], events: {} };
                        }
                        filter(key, op, compare) {
                            ...
                            this[_private].filters.push({ key: key, op: op, compare: compare });
                            return this;
                        }
                        ...
                        sort(key, ascending = true) {
                            ...
                            this[_private].order.push({ key: key, ascending: ascending });
                            return this;
                        }
                        ...
                        get(optionsOrCallback, callback) {
                            ...
                            options.eventHandler = (ev) => {
                                ...
                                if (['add', 'change', 'remove'].includes(ev.name)) {
                                    const eventData = { name: ev.name, ref: new DataReference(this.ref.db, ev.path) };
                            ...
                            return db.api
                                ...
                                .then((res) => {
                                    const { stop: stop } = res;
                                    let { results: results, context: context } = res;
                                    this.stop = async () => {
                                        await stop();
                                    };
                        ...
                        async remove(callback) {
                            ...
                            const promises = Object.keys(parentUpdates).map(async (parentPath) => {
                                ...
                                try {
                                    ...
                                    return { ref: ref, success: false, error: error };
                                }
                            });
                        ...
                        async forEach(callbackOrOptions, callback) {
                            ...
                            const refs = await this.find();
                            const summary = { canceled: false, total: refs.length, processed: 0 };
            ...
            24: [
                function (require, module, exports) {
                    ...
                    class ID {
                        ...
                        static generate() {
                            return (0, cuid_1.default)(timeBias).slice(1);
                        }
                    }
                    exports.ID = ID;
                },
            ...
            27: [
                function (require, module, exports) {
                    ...
                    (async () => {
                        ...
                        try {
                            const { Observable: Observable } = await Promise.resolve().then(() => require('rxjs'));
            ...
            29: [
                function (require, module, exports) {
                    ...
                    function getPathKeys(path) {
                        ...
                        return keys.map((key) => (key.startsWith('[') ? parseInt(key.slice(1, -1)) : key));
                    }
                    class PathInfo {
                        constructor(path) {
            ...
            32: [
                function (require, module, exports) {
                    ...
                    function checkObject(path, properties, obj, partial) {
                        const invalidProperties = properties.find((prop) => prop.name === '*' || prop.name[0] === '$')
                            ? []
                            : Object.keys(obj).filter(
                                  (key) => ![null, undefined].includes(obj[key]) && !properties.find((prop) => prop.name === key)
                              );
                            ...
                            if (this.options.maxEntries > 0 && this.cache.size >= this.options.maxEntries && !this.cache.has(key)) {
                                ...
                                for (const [key, entry] of this.cache.entries()) {
                                    ...
                                    if (!oldest || entry.accessed < oldest.accessed) {
                                        oldest = { key: key, accessed: entry.accessed };
                                    }
                                }
                                if (oldest !== null) {
            ...
            34: [
                function (require, module, exports) {
                    ...
                    const process_1 = require('./process');
                    const FontCode = { bold: 1, dim: 2, italic: 3, underline: 4, inverse: 7, hidden: 8, strikethrough: 94 };
                    const ColorCode = {
                        black: 30,
                        red: 31,
                        green: 32,
                ...
                function (require, module, exports) {
                    ...
                    class SimpleEventEmitter {
                        ...
                        on(event, callback) {
                            ...
                            this._subscriptions.push({ event: event, callback: callback, once: false });
                            return this;
                        }
                        off(event, callback) {
                        ...
                        once(event, callback) {
                            return new Promise((resolve) => {
                                ...
                                if (this._oneTimeEvents.has(event)) {
                                    ...
                                    this._subscriptions.push({ event: event, callback: ourCallback, once: true });
                                }
                            });
                        }
                        emit(event, data) {
            ...
            36: [
                function (require, module, exports) {
                    ...
                    class EventSubscription {
                        constructor(stop) {
                            this.stop = stop;
                            this._internal = { state: 'init', activatePromises: [] };
                        }
                        activated(callback) {
                            if (callback) {
                                this._internal.activatePromises.push({ callback: callback });
                            ...
                            return new Promise((resolve, reject) => {
                                ...
                                const noop = () => {};
                                this._internal.activatePromises.push({ resolve: resolve, reject: callback ? noop : reject });
                            });
                        }
                ...
                function (require, module, exports) {
                    ...
                    const serialize = (obj) => {
                        ...
                        if (
                            ...
                            return { map: (_a = ser.map) === null || _a === void 0 ? void 0 : _a.value, val: ser.val.value };
                        }
                        ...
                        const process = (obj, mappings, prefix) => {
                            ...
                            Object.keys(obj).forEach((key) => {
                                ...
                                if (typeof val === 'bigint') {
                                    ...
                                    obj[key] = ascii85_1.ascii85.encode(val);
                    ...
                    const serialize2 = (obj) => {
                        const getSerializedValue = (val) => {
                            if (typeof val === 'bigint') {
                                return { '.type': 'bigint', '.val': val.toString() };
                            } else if (val instanceof Date) {
                                return { '.type': 'date', '.val': val.toISOString() };
                            } else if (val instanceof ArrayBuffer) {
                                return { '.type': 'binary', '.val': ascii85_1.ascii85.encode(val) };
                            } else if (val instanceof path_reference_1.PathReference) {
                                return { '.type': 'reference', '.val': val.path };
                            } else if (val instanceof RegExp) {
                                return { '.type': 'regexp', '.val': `/${val.source}/${val.flags}` };
                            } else if (typeof val === 'object' && val !== null) {
            ...
            38: [
                function (require, module, exports) {
                    ...
                    function process(db, mappings, path, obj, action) {
                        ...
                        m.forEach((mapping) => {
                            const mkeys = path_info_1.PathInfo.getPathKeys(mapping.path);
                            mkeys.push('*');
                            ...
                            const process = (parentPath, parent, keys) => {
                                ...
                                if (key === '*' || (typeof key === 'string' && key[0] === '$')) {
                                    if (parent instanceof Array) {
                                        children = parent.map((val, index) => ({ key: index, val: val }));
                                    } else {
                                    ...
                                    if (typeof child === 'object') {
                                        children.push({ key: key, val: child });
                                    }
                                }
                                children.forEach((child) => {
                                    ...
                                    if (keys.length === 1) {
                                        if (action === 'serialize') {
                                            changes.push({ parent: parent, key: child.key, original: parent[child.key] });
                ...
                function (require, module, exports) {
                    (function (global, Buffer) {
                        (function () {
                            ...
                            const big = { zero: BigInt(0), one: BigInt(1), two: BigInt(2), eight: BigInt(8), ff: BigInt(255) };
                                ...
                                const process = (target, compareResult, prev, val) => {
                                    switch (compareResult) {
                                        case 'identical':
                                            return [];
                                        case 'changed':
                                            return [{ target: target, prev: prev, val: val }];
                                        case 'added':
                                            return [{ target: target, prev: null, val: val }];
                                        case 'removed':
                                            return [{ target: target, prev: prev, val: null }];
                                        default: {
                                            let changes = [];
                            ...
                            !(function (t, e) {
                                ...
                                return (function (t) {
                                    ...
                                    function (t, e) {
                                        ...
                                        /*! https://mths.be/utf8js v2.1.2 by @mathias */ var u,
                                            f,
                                            l,
