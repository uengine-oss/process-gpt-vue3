...
const PATHS: Record<string, string> = {
    ...
    // 말로 주고받는 대화. 받아쓰기(microphone)와 구분되어야 한다 —
    // 같은 마이크 모양을 두 개 두면 무엇이 무엇인지 알 수 없다.
    waveform:
        'M9,3V21H11V3H9M5,7V17H7V7H5M13,7V17H15V7H13M17,10V14H19V10H17M1,10V14H3V10H1M21,10V14H23V10H21Z',
