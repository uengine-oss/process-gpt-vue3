...
-- Date: 2026-02-26
-- Description: 9개의 마이그레이션 파일을 하나로 통합
--   - 20260130_bpmn_model_tables.sql
--   - 20260130_proc_def_comments_approval.sql
--   - 20260130_standard_terminology.sql
--   - 20260209_property_schema_enhancement.sql
--   - 20260213_add_cancelled_state.sql
--   - 20260213_assigned_reviewer.sql
--   - 20260213_kpi_review_board.sql
--   - 20260213_review_per_submission.sql
--   - 20260223_governance_workflow.sql
--
-- NOTE: 이 파일은 초기 DB 셋업용 통합본입니다.
--       기존 운영 DB에는 개별 마이그레이션을 순서대로 적용하세요.
-- =====================================================
